...
function pg_get_relay_lap_number( $relay_key = '49ba4c' ){
    global $wpdb;
...
function pg_current_global_lap( $relay_key = '49ba4c' ) : array {
    /**
     * Example:
     *  [lap_number] => 5
     *  [post_id] => 19
...
function pg_get_relay_current_lap( $relay_key = '49ba4c' ){
    /**
     * Example:
     *  [lap_number] => 5
     *  [post_id] => 19
...
function pg_get_lap_stats( int $relay_id, int $lap_number ){

    $relay = DT_Posts::get_post( 'relays', $relay_id, true, false );
    $current_lap_number = pg_get_relay_lap_number( $relay['prayer_app_relay_key'] );
...
function pg_stats_since_start_of_relay( $relay_id ) {
    $relay = DT_Posts::get_post( 'relays', $relay_id, true, false );
    $current_lap_number = pg_get_relay_lap_number( $relay['prayer_app_relay_key'] );
