            ...
            jQuery.each( data, function(i,v){
              ...
              if ( v.status === 'active' ){
                html_content_active += `<tr>
                                <td>${v.start_time}</td>
                                <th><a href="/prayer_app/custom/${v.lap_key}">${v.post_title} ${jsObject.is_rolling_laps_feature_on ? `#${lapNumber}` : ''}</a></th>
                ...
                html_content_completed += `<tr>
                                <td>${v.start_time}</td>
                                <th><a href="/prayer_app/custom/${v.lap_key}/map">${v.post_title} ${jsObject.is_rolling_laps_feature_on && v.single_lap === '1' ? '' : `#${lapNumber}`}</a></th>
