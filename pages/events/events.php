...
class PG_Events extends PG_Public_Page {
    ...
    public function body(){
        ...
        <div class="page">
            ...
            <section class="container" id="pre-event">
            ...
            <section class="bg-grey-light" style="background-color: #f3f5f8">
                <div class="container">
                    <h5><?php echo esc_html__( 'Sample Goals', 'prayer-global-porch' ) ?></h5>
            ...
            <section id="promotion" class="bg-brand-light">
                <div class="container">
                    ...
                    <div class="switcher">
                        ...
                        <img src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/images/3X5Mockup-PGonly.png" alt="">
                    </div>
                </div>
                <a class="btn btn-outline-primary text-center" href="#promotion"><?php echo esc_html__( 'Promo resources', 'prayer-global-porch' ) ?></a>
            </section>
            <section class="container">
                ...
                <div class="switcher">
                    ...
                    <img src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/images/SingleBanner-Mockup.png" alt="">
                </div>
                <p class="font-italic">
            ...
            <section>
                <img src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/images/LargeEvent-Mockup2.jpg" alt="">
                <div class="container">
            ...
            <section>
                <div class="switcher">
                    <img src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/images/iphonemockup-invite.jpg" alt="">
                    <img src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/images/iphonemockup-invite.jpg" alt="">
                    <img src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/images/iphonemockup-invite.jpg" alt="">
                </div>
            </section>
            <section id="helpful-tips" class="bg-brand-light">
                <div class="container">
            ...
            <section id="post-event" class="container">
            ...
            <section class="container">
                ...
                <a class="btn btn-primary-light" href="https://prayer.global/dashboard"><?php echo esc_html__( 'Create Group Relay', 'prayer-global-porch' ) ?></a>
