...
$title_translated = $this->title_translated;
$title_translated_plural = $this->title_translated_plural;

$is_conference = $this instanceof PG_Conferences;
$is_church = $this instanceof PG_Churches;
...
<div class="page">
    <section class="container">
        <div class="row justify-content-md-center mb-5 stack-md">
            <h1 class="text-center"><?php echo esc_html( sprintf( __( 'Using Prayer.Global at your %s', 'prayer-global-porch' ), $title_translated ) ) ?></h1>

            <?php if ( $is_church || $is_conference ) : ?>

                <p class="text-center font-weight-bold font-italic f-sm"><?php echo esc_html( sprintf( __( 'Prayer.Global has been used by %s with great success! ', 'prayer-global-porch' ), $title_translated_plural ) ) ?></p>

            <?php elseif ( $is_event ) : ?>

                <p class="text-center font-weight-bold font-italic f-sm"><?php echo esc_html( sprintf( __( 'Prayer.Global has been used by %s with great success! ', 'prayer-global-porch' ), esc_html__( 'churches and conferences', 'prayer-global-porch' ) ) ) ?></p>

            <?php endif; ?>

            <div class="switcher switcher-md">

                <?php if ( $is_event || $is_conference ) : ?>
                ...
                <?php if ( $is_event || $is_church ) : ?>
                    ...
                    <div>
                        ...
                        <script src="https://player.vimeo.com/api/player.js"></script>
                        <p class="text-center font-title f-sm"><?php echo esc_html__( 'Church Testimony', 'prayer-global-porch' ) ?></p>
                    </div>
    ...
    <section class="container | py-5">
        ...
        <ul>
            ...
            <?php if ( $is_church || $is_conference ) : ?>
                ...
                <li><strong><?php echo esc_html__( 'Access free promotional resources', 'prayer-global-porch' ) ?>:</strong> <?php echo esc_html( sprintf( __( 'Easily promote your event with customizable materials for your %s.', 'prayer-global-porch' ), $title_translated ) ) ?></li>

            <?php elseif ( $is_event ) : ?>

                <li><strong><?php echo esc_html__( 'Access free promotional resources', 'prayer-global-porch' ) ?>:</strong> <?php echo esc_html( sprintf( __( 'Easily promote your event with customizable materials for your %s.', 'prayer-global-porch' ), esc_html__( 'church or conference', 'prayer-global-porch' ) ) ) ?></li>
