...
<section class="pb_section pb_section_v1" data-section="lap" id="section-lap">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md text-center">
                <a href="/prayer_app/subscribe/" role="button" class="btn smoothscroll pb_outline-dark btn-xl pb_font-13 p-4 rounded-0 pb_letter-spacing-2">All Previous Stats</a>
            </div>
        </div>
    </div>
</section>
