    ...
    public function wp_enqueue_scripts() {
        if ( is_user_logged_in() ) {
            ...
            $available_badges = [
                ...
                [
                    ...
                    'progression_badges' => [
                        ...
                        [
                            'id' => 'streak_30',
                            'title' => '30 Day Streak',
                            'description_unearned' => 'Earn this badge by praying for 30 days straight',
                            'description_earned' => 'You earned this badge by praying for 30 days straight',
                            'value' => 30,
                            'image' => $badge_images_url . 'streak_30.png',
                            'bw_image' => $badge_images_url . 'streak_30_bw.png',
                            'has_earned_badge' => false,
                        ],
                        [
                            'id' => 'streak_40',
                            'title' => '40 Day Streak',
                            'description_unearned' => 'Earn this badge by praying for 40 days straight',
                            'description_earned' => 'You earned this badge by praying for 40 days straight',
                            'value' => 40,
                            'image' => $badge_images_url . 'streak_40.png',
                            'bw_image' => $badge_images_url . 'streak_40_bw.png',
                            'has_earned_badge' => false,
                        ],
                    ],
                ],
                ...
                [
                    ...
                    'description_unearned' => 'Earn this badge by praying for 25 locations in a relay',
                    'description_earned' => 'You earned this badge by praying for 25 locations in a relay',
                    'value' => 25,
                    'image' => $badge_images_url . 'location_25.png',
                    'bw_image' => $badge_images_url . 'location_25_bw.png',
                    'has_earned_badge' => false,
                    'type' => 'progression',
                    'category' => 'location',
                    ...
                    'progression_badges' => [
                        ...
                        [
                            ...
                            'title' => 'Relay Location 50',
                            'description_unearned' => 'Earn this badge by praying for 50 locations in a relay',
                            'description_earned' => 'You earned this badge by praying for 50 locations in a relay',
                            'value' => 50,
                            'image' => $badge_images_url . 'location_50.png',
                            'bw_image' => $badge_images_url . 'location_50_bw.png',
                            'has_earned_badge' => false,
                        ],
                        [
                            'id' => 'relay_location_75',
                            'title' => 'Relay Location 75',
                            'description_unearned' => 'Earn this badge by praying for 75 locations in a relay',
                            'description_earned' => 'You earned this badge by praying for 75 locations in a relay',
                            'value' => 75,
                            'image' => $badge_images_url . 'location_75.png',
                            'bw_image' => $badge_images_url . 'location_75_bw.png',
                            'has_earned_badge' => false,
                        ],
                        [
                            'id' => 'relay_location_100',
                            'title' => 'Relay Location 100',
                            ...
                            'value' => 100,
                            'image' => $badge_images_url . 'location_100.png',
                            'bw_image' => $badge_images_url . 'location_100_bw.png',
                            'has_earned_badge' => false,
                        ],
                        [
                            'id' => 'relay_location_150',
                            'title' => 'Relay Location 150',
                            'description_unearned' => 'Earn this badge by praying for 150 locations in a relay',
                            'description_earned' => 'You earned this badge by praying for 150 locations in a relay',
                            'value' => 150,
                            'image' => $badge_images_url . 'location_150.png',
                            'bw_image' => $badge_images_url . 'location_150_bw.png',
                            'has_earned_badge' => false,
                        ],
                        [
                            'id' => 'relay_location_200',
                            'title' => 'Relay Location 200',
                            'description_unearned' => 'Earn this badge by praying for 200 locations in a relay',
                            'description_earned' => 'You earned this badge by praying for 200 locations in a relay',
                            'value' => 200,
                            'image' => $badge_images_url . 'location_200.png',
                            'bw_image' => $badge_images_url . 'location_200_bw.png',
                            'has_earned_badge' => false,
                        ],
                        [
                            'id' => 'relay_location_250',
                            'title' => 'Relay Location 250',
                            'description_unearned' => 'Earn this badge by praying for 250 locations in a relay',
                            'description_earned' => 'You earned this badge by praying for 250 locations in a relay',
                            'value' => 250,
                            'image' => $badge_images_url . 'location_250.png',
                            'bw_image' => $badge_images_url . 'location_250_bw.png',
                            'has_earned_badge' => false,
                        ],
                    ],
                ],
        ...
        wp_localize_script( 'components-js', 'jsObject', [
            ...
            'translations' => [
                ...
                'earned_retroactively' => esc_html_x( 'Earned retroactively %s', 'Earned retroactively 25/12/2025', 'prayer-global-porch' ),
