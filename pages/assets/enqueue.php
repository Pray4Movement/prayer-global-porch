...
add_action( 'wp_enqueue_scripts', function (){
    ...
    pg_enqueue_script( 'global-functions', 'pages/assets/js/global-functions.js', [ 'bootstrap', 'median-tools' ], [ 'strategy' => 'defer' ] );
    pg_enqueue_script( 'median-tools', 'pages/assets/js/median-tools.js', [], [ 'strategy' => 'defer' ] );
