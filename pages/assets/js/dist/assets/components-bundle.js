 ...
 */const G=globalThis,bt=G.ShadowRoot&&(G.ShadyCSS===void 0||G.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,mt=Symbol(),At=new WeakMap;let Ht=class{constructor(t,s,a){if(this._$cssResult$=!0,a!==mt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(bt&&t===void 0){const a=s!==void 0&&s.length===1;a&&(t=At.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&At.set(s,t))}return t}toString(){return this.cssText}};const Kt=e=>new Ht(typeof e=="string"?e:e+"",void 0,mt),_t=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((a,i,r)=>a+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[r+1],e[0]);return new Ht(s,e,mt)},Xt=(e,t)=>{if(bt)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const a=document.createElement("style"),i=G.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=s.cssText,e.appendChild(a)}},Ot=bt?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const a of t.cssRules)s+=a.cssText;return Kt(s)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Zt,defineProperty:Qt,getOwnPropertyDescriptor:Gt,getOwnPropertyNames:Yt,getOwnPropertySymbols:te,getPrototypeOf:ee}=Object,E=globalThis,xt=E.trustedTypes,se=xt?xt.emptyScript:"",dt=E.reactiveElementPolyfillSupport,F=(e,t)=>e,Y={toAttribute(e,t){switch(t){case Boolean:e=e?se:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},vt=(e,t)=>!Zt(e,t),Pt={attribute:!0,type:String,converter:Y,reflect:!1,hasChanged:vt};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),E.litPropertyMetadata??(E.litPropertyMetadata=new WeakMap);class M extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Pt){if(s.state&&(s.attribute=!1),this._$Ei(),this.elementProperties.set(t,s),!s.noAccessor){const a=Symbol(),i=this.getPropertyDescriptor(t,a,s);i!==void 0&&Qt(this.prototype,t,i)}}static getPropertyDescriptor(t,s,a){const{get:i,set:r}=Gt(this.prototype,t)??{get(){return this[s]},set(n){this[s]=n}};return{get(){return i==null?void 0:i.call(this)},set(n){const d=i==null?void 0:i.call(this);r.call(this,n),this.requestUpdate(t,d,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Pt}static _$Ei(){if(this.hasOwnProperty(F("elementProperties")))return;const t=ee(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(F("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(F("properties"))){const s=this.properties,a=[...Yt(s),...te(s)];for(const i of a)this.createProperty(i,s[i])}const t=this[Symbol.metadata];if(t!==null){const s=litPropertyMetadata.get(t);if(s!==void 0)for(const[a,i]of s)this.elementProperties.set(a,i)}this._$Eh=new Map;for(const[s,a]of this.elementProperties){const i=this._$Eu(s,a);i!==void 0&&this._$Eh.set(i,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const s=[];if(Array.isArray(t)){const a=new Set(t.flat(1/0).reverse());for(const i of a)s.unshift(Ot(i))}else t!==void 0&&s.push(Ot(t));return s}static _$Eu(t,s){const a=s.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(s=>this.enableUpdating=s),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(s=>s(this))}addController(t){var s;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((s=t.hostConnected)==null||s.call(t))}removeController(t){var s;(s=this._$EO)==null||s.delete(t)}_$E_(){const t=new Map,s=this.constructor.elementProperties;for(const a of s.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Xt(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(s=>{var a;return(a=s.hostConnected)==null?void 0:a.call(s)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(s=>{var a;return(a=s.hostDisconnected)==null?void 0:a.call(s)})}attributeChangedCallback(t,s,a){this._$AK(t,a)}_$EC(t,s){var r;const a=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,a);if(i!==void 0&&a.reflect===!0){const n=(((r=a.converter)==null?void 0:r.toAttribute)!==void 0?a.converter:Y).toAttribute(s,a.type);this._$Em=t,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(t,s){var r;const a=this.constructor,i=a._$Eh.get(t);if(i!==void 0&&this._$Em!==i){const n=a.getPropertyOptions(i),d=typeof n.converter=="function"?{fromAttribute:n.converter}:((r=n.converter)==null?void 0:r.fromAttribute)!==void 0?n.converter:Y;this._$Em=i,this[i]=d.fromAttribute(s,n.type),this._$Em=null}}requestUpdate(t,s,a){if(t!==void 0){if(a??(a=this.constructor.getPropertyOptions(t)),!(a.hasChanged??vt)(this[t],s))return;this.P(t,s,a)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,s,a){this._$AL.has(t)||this._$AL.set(t,s),a.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var a;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,n]of this._$Ep)this[r]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[r,n]of i)n.wrapped!==!0||this._$AL.has(r)||this[r]===void 0||this.P(r,this[r],n)}let t=!1;const s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),(a=this._$EO)==null||a.forEach(i=>{var r;return(r=i.hostUpdate)==null?void 0:r.call(i)}),this.update(s)):this._$EU()}catch(i){throw t=!1,this._$EU(),i}t&&this._$AE(s)}willUpdate(t){}_$AE(t){var s;(s=this._$EO)==null||s.forEach(a=>{var i;return(i=a.hostUpdated)==null?void 0:i.call(a)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(s=>this._$EC(s,this[s]))),this._$EU()}updated(t){}firstUpdated(t){}}M.elementStyles=[],M.shadowRootOptions={mode:"open"},M[F("elementProperties")]=new Map,M[F("finalized")]=new Map,dt==null||dt({ReactiveElement:M}),(E.reactiveElementVersions??(E.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=globalThis,tt=J.trustedTypes,jt=tt?tt.createPolicy("lit-html",{createHTML:e=>e}):void 0,Bt="$lit$",S=`lit$${Math.random().toFixed(9).slice(2)}$`,Lt="?"+S,ie=`<${Lt}>`,R=document,V=()=>R.createComment(""),K=e=>e===null||typeof e!="object"&&typeof e!="function",ft=Array.isArray,ae=e=>ft(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",ct=`[ 	
\f\r]`,q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,St=/-->/g,Et=/>/g,T=RegExp(`>|${ct}(?:([^\\s"'>=/]+)(${ct}*=${ct}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ct=/'/g,kt=/"/g,zt=/^(?:script|style|textarea|title)$/i,ne=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),l=ne(1),I=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),Tt=new WeakMap,U=R.createTreeWalker(R,129);function qt(e,t){if(!ft(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return jt!==void 0?jt.createHTML(t):t}const re=(e,t)=>{const s=e.length-1,a=[];let i,r=t===2?"<svg>":t===3?"<math>":"",n=q;for(let d=0;d<s;d++){const o=e[d];let h,p,c=-1,b=0;for(;b<o.length&&(n.lastIndex=b,p=n.exec(o),p!==null);)b=n.lastIndex,n===q?p[1]==="!--"?n=St:p[1]!==void 0?n=Et:p[2]!==void 0?(zt.test(p[2])&&(i=RegExp("</"+p[2],"g")),n=T):p[3]!==void 0&&(n=T):n===T?p[0]===">"?(n=i??q,c=-1):p[1]===void 0?c=-2:(c=n.lastIndex-p[2].length,h=p[1],n=p[3]===void 0?T:p[3]==='"'?kt:Ct):n===kt||n===Ct?n=T:n===St||n===Et?n=q:(n=T,i=void 0);const u=n===T&&e[d+1].startsWith("/>")?" ":"";r+=n===q?o+ie:c>=0?(a.push(h),o.slice(0,c)+Bt+o.slice(c)+S+u):o+S+(c===-2?d:u)}return[qt(e,r+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class X{constructor({strings:t,_$litType$:s},a){let i;this.parts=[];let r=0,n=0;const d=t.length-1,o=this.parts,[h,p]=re(t,s);if(this.el=X.createElement(h,a),U.currentNode=this.el.content,s===2||s===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(i=U.nextNode())!==null&&o.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(const c of i.getAttributeNames())if(c.endsWith(Bt)){const b=p[n++],u=i.getAttribute(c).split(S),_=/([.?@])?(.*)/.exec(b);o.push({type:1,index:r,name:_[2],strings:u,ctor:_[1]==="."?le:_[1]==="?"?de:_[1]==="@"?ce:rt}),i.removeAttribute(c)}else c.startsWith(S)&&(o.push({type:6,index:r}),i.removeAttribute(c));if(zt.test(i.tagName)){const c=i.textContent.split(S),b=c.length-1;if(b>0){i.textContent=tt?tt.emptyScript:"";for(let u=0;u<b;u++)i.append(c[u],V()),U.nextNode(),o.push({type:2,index:++r});i.append(c[b],V())}}}else if(i.nodeType===8)if(i.data===Lt)o.push({type:2,index:r});else{let c=-1;for(;(c=i.data.indexOf(S,c+1))!==-1;)o.push({type:7,index:r}),c+=S.length-1}r++}}static createElement(t,s){const a=R.createElement("template");return a.innerHTML=t,a}}function H(e,t,s=e,a){var n,d;if(t===I)return t;let i=a!==void 0?(n=s._$Co)==null?void 0:n[a]:s._$Cl;const r=K(t)?void 0:t._$litDirective$;return(i==null?void 0:i.constructor)!==r&&((d=i==null?void 0:i._$AO)==null||d.call(i,!1),r===void 0?i=void 0:(i=new r(e),i._$AT(e,s,a)),a!==void 0?(s._$Co??(s._$Co=[]))[a]=i:s._$Cl=i),i!==void 0&&(t=H(e,i._$AS(e,t.values),i,a)),t}let oe=class{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:a}=this._$AD,i=((t==null?void 0:t.creationScope)??R).importNode(s,!0);U.currentNode=i;let r=U.nextNode(),n=0,d=0,o=a[0];for(;o!==void 0;){if(n===o.index){let h;o.type===2?h=new L(r,r.nextSibling,this,t):o.type===1?h=new o.ctor(r,o.name,o.strings,this,t):o.type===6&&(h=new he(r,this,t)),this._$AV.push(h),o=a[++d]}n!==(o==null?void 0:o.index)&&(r=U.nextNode(),n++)}return U.currentNode=R,i}p(t){let s=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,s),s+=a.strings.length-2):a._$AI(t[s])),s++}};class L{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,s,a,i){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=a,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=H(this,t,s),K(t)?t===v||t==null||t===""?(this._$AH!==v&&this._$AR(),this._$AH=v):t!==this._$AH&&t!==I&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ae(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==v&&K(this._$AH)?this._$AA.nextSibling.data=t:this.T(R.createTextNode(t)),this._$AH=t}$(t){var r;const{values:s,_$litType$:a}=t,i=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=X.createElement(qt(a.h,a.h[0]),this.options)),a);if(((r=this._$AH)==null?void 0:r._$AD)===i)this._$AH.p(s);else{const n=new oe(i,this),d=n.u(this.options);n.p(s),this.T(d),this._$AH=n}}_$AC(t){let s=Tt.get(t.strings);return s===void 0&&Tt.set(t.strings,s=new X(t)),s}k(t){ft(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let a,i=0;for(const r of t)i===s.length?s.push(a=new L(this.O(V()),this.O(V()),this,this.options)):a=s[i],a._$AI(r),i++;i<s.length&&(this._$AR(a&&a._$AB.nextSibling,i),s.length=i)}_$AR(t=this._$AA.nextSibling,s){var a;for((a=this._$AP)==null?void 0:a.call(this,!1,!0,s);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var s;this._$AM===void 0&&(this._$Cv=t,(s=this._$AP)==null||s.call(this,t))}}class rt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,a,i,r){this.type=1,this._$AH=v,this._$AN=void 0,this.element=t,this.name=s,this._$AM=i,this.options=r,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=v}_$AI(t,s=this,a,i){const r=this.strings;let n=!1;if(r===void 0)t=H(this,t,s,0),n=!K(t)||t!==this._$AH&&t!==I,n&&(this._$AH=t);else{const d=t;let o,h;for(t=r[0],o=0;o<r.length-1;o++)h=H(this,d[a+o],s,o),h===I&&(h=this._$AH[o]),n||(n=!K(h)||h!==this._$AH[o]),h===v?t=v:t!==v&&(t+=(h??"")+r[o+1]),this._$AH[o]=h}n&&!i&&this.j(t)}j(t){t===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class le extends rt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===v?void 0:t}}class de extends rt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==v)}}class ce extends rt{constructor(t,s,a,i,r){super(t,s,a,i,r),this.type=5}_$AI(t,s=this){if((t=H(this,t,s,0)??v)===I)return;const a=this._$AH,i=t===v&&a!==v||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,r=t!==v&&(a===v||i);i&&this.element.removeEventListener(this.name,this,a),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,t):this._$AH.handleEvent(t)}}class he{constructor(t,s,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}}const pe={I:L},ht=J.litHtmlPolyfillSupport;ht==null||ht(X,L),(J.litHtmlVersions??(J.litHtmlVersions=[])).push("3.2.1");const ue=(e,t,s)=>{const a=(s==null?void 0:s.renderBefore)??t;let i=a._$litPart$;if(i===void 0){const r=(s==null?void 0:s.renderBefore)??null;a._$litPart$=i=new L(t.insertBefore(V(),r),r,void 0,s??{})}return i._$AI(e),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let C=class extends M{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var s;const t=super.createRenderRoot();return(s=this.renderOptions).renderBefore??(s.renderBefore=t.firstChild),t}update(t){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=ue(s,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return I}};var Mt;C._$litElement$=!0,C.finalized=!0,(Mt=globalThis.litElementHydrateSupport)==null||Mt.call(globalThis,{LitElement:C});const pt=globalThis.litElementPolyfillSupport;pt==null||pt({LitElement:C});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ge={attribute:!0,type:String,converter:Y,reflect:!1,hasChanged:vt},be=(e=ge,t,s)=>{const{kind:a,metadata:i}=s;let r=globalThis.litPropertyMetadata.get(i);if(r===void 0&&globalThis.litPropertyMetadata.set(i,r=new Map),r.set(s.name,e),a==="accessor"){const{name:n}=s;return{set(d){const o=t.get.call(this);t.set.call(this,d),this.requestUpdate(n,o,e)},init(d){return d!==void 0&&this.P(n,void 0,e),d}}}if(a==="setter"){const{name:n}=s;return function(d){const o=this[n];t.call(this,d),this.requestUpdate(n,o,e)}}throw Error("Unsupported decorator location: "+a)};function m(e){return(t,s)=>typeof s=="object"?be(e,t,s):((a,i,r)=>{const n=i.hasOwnProperty(r);return i.constructor.createProperty(r,n?{...a,wrapped:!0}:a),n?Object.getOwnPropertyDescriptor(i,r):void 0})(e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function g(e){return m({...e,state:!0,attribute:!1})}var me=Object.defineProperty,_e=Object.getOwnPropertyDescriptor,Wt=(e,t,s,a)=>{for(var i=a>1?void 0:a?_e(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&me(t,s,i),i};let et=class extends C{constructor(){super(...arguments),this.text=""}updated(e){e.has("text")&&document.querySelectorAll("pg-avatar").forEach(s=>{s.text!==this.text&&(s.text=this.text)})}getInitials(e){const t=e.split(" ").map(s=>s[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return l`
      <div class="circle">
    ...
    `];Wt([m({type:String})],et.prototype,"text",2);et=Wt([f("pg-avatar")],et);function ve(e){return e?JSON.parse('{"'+e.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}function fe(e,t){let s={};const a=e.split("/").filter(r=>r!=""),i=t.split("/").filter(r=>r!="");return a.map((r,n)=>{/^:/.test(r)&&(s[r.substring(1)]=i[n])}),s}function $e(e){return e?new RegExp("^(|/)"+e.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}function ye(e,t){if($e(t).test(e))return!0}function we(e){return class extends e{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...t){super(...t),this.route="",this.canceled=!1}connectedCallback(...t){super.connectedCallback(...t),this.routing(this.constructor.routes,(...s)=>this.router(...s)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...s)=>this.router(...s))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(t,s,a,i,r,n){n&&n(t,s,a,i),r(t,s,a,i)}routing(t,s){this.canceled=!0;const a=decodeURI(window.location.pathname),i=decodeURI(window.location.search);let r=t.filter(o=>o.pattern==="*")[0],n=t.filter(o=>o.pattern!=="*"&&ye(a,o.pattern))[0],d=ve(i);n?(n.params=fe(n.pattern,a),n.data=n.data||{},n.authentication&&n.authentication.authenticate&&typeof n.authentication.authenticate=="function"?(this.canceled=!1,Promise.resolve(n.authentication.authenticate.bind(this).call()).then(o=>{this.canceled||(o?n.authorization&&n.authorization.authorize&&typeof n.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(n.authorization.authorize.bind(this).call()).then(h=>{this.canceled||(h?this.routed(n.name,n.params,d,n.data,s,n.callback):this.routed(n.authorization.unauthorized.name,n.params,d,n.data,s,n.callback))})):this.routed(n.name,n.params,d,n.data,s,n.callback):this.routed(n.authentication.unauthenticated.name,n.params,d,n.data,s,n.callback))})):n.authorization&&n.authorization.authorize&&typeof n.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(n.authorization.authorize.bind(this).call()).then(o=>{this.canceled||(o?this.routed(n.name,n.params,d,n.data,s,n.callback):this.routed(n.authorization.unauthorized.name,n.params,d,n.data,s,n.callback))})):this.routed(n.name,n.params,d,n.data,s,n.callback)):r&&(r.data=r.data||{},this.routed(r.name,{},d,r.data,s,r.callback))}}}function z(e){return class extends e{navigate(t){window.history.pushState({},null,t),window.dispatchEvent(new CustomEvent("route"))}}}class w extends C{constructor(){super()}createRenderRoot(){return this}}var Ae=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,Ft=(e,t,s,a)=>{for(var i=a>1?void 0:a?Oe(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&Ae(t,s,i),i};let gt=class extends z(w){constructor(){super(...arguments),this.badge={}}getImageUrl(){return this.badge.has_earned_badge?this.badge.image:this.badge.bw_image}render(){return l`
            ...
            >
                <div class="badge-image-wrapper">
                    ...
                    ${this.badge.type==="multiple"&&this.badge.no_times_earned>1?l`
                        <div class="badge-times-earned">x${this.badge.no_times_earned}</div>
                    `:""}
                </div>
                <span>${this.badge.title}</span>
            </div>
        `}};Ft([m({type:Object})],gt.prototype,"badge",2);gt=Ft([f("pg-badge")],gt);var xe=Object.defineProperty,Pe=Object.getOwnPropertyDescriptor,$t=(e,t,s,a)=>{for(var i=a>1?void 0:a?Pe(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&xe(t,s,i),i};let st=class extends z(w){constructor(){super(...arguments),this.title="",this.backUrl=""}render(){return l`
    ...
    `}};$t([m({type:String})],st.prototype,"title",2);$t([m({type:String})],st.prototype,"backUrl",2);st=$t([f("pg-header")],st);var je=Object.defineProperty,Se=Object.getOwnPropertyDescriptor,Jt=(e,t,s,a)=>{for(var i=a>1?void 0:a?Se(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&je(t,s,i),i};let it=class extends C{constructor(){super(...arguments),this.open=!1,this.modalId=this.generateId()}generateId(){return Array(6).fill("").map(()=>String.fromCharCode(97+Math.floor(Math.random()*26))).join("")}render(){return l`
      <div
    ...
    `}close(){this.dispatchEvent(new CustomEvent("close"))}};it.styles=[_t`
      :root {
        font-size: 18px;
      }
      .modal {
    ...
    `];Jt([m({type:Boolean})],it.prototype,"open",2);it=Jt([f("pg-modal")],it);var Ee=Object.defineProperty,Ce=Object.getOwnPropertyDescriptor,Vt=(e,t,s,a)=>{for(var i=a>1?void 0:a?Ce(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&Ee(t,s,i),i};let at=class extends z(C){constructor(){super(),this.href="",this.setAttribute("tabindex","0"),this.setAttribute("role","link"),this.addEventListener("click",this.handleClick),this.addEventListener("keydown",this.handleKeydown)}handleClick(e){e.preventDefault();const{href:t}=e.currentTarget;this.navigate(t)}handleKeydown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this.navigate(this.href))}render(){return l` <slot></slot> `}};at.styles=_t`
    :host {
      cursor: pointer;
    }
    a {
  ...
  `;Vt([m({type:String})],at.prototype,"href",2);at=Vt([f("nav-link")],at);var ke=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,O=(e,t,s,a)=>{for(var i=a>1?void 0:a?Te(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&ke(t,s,i),i};let $=class extends w{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.isOwner=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return l`
      <svg>
    ...
    `}};x([m({type:Boolean})],y.prototype,"edit",2);x([m({type:Object})],y.prototype,"relay",2);x([g()],y.prototype,"type",2);x([g()],y.prototype,"title",2);x([g()],y.prototype,"showAdvancedOptions",2);x([g()],y.prototype,"startDate",2);x([g()],y.prototype,"startTime",2);x([g()],y.prototype,"endDate",2);x([g()],y.prototype,"endTime",2);x([g()],y.prototype,"isSingle",2);y=x([f("pg-relay-form")],y);var Re=Object.getOwnPropertyDescriptor,Ie=(e,t,s,a)=>{for(var i=a>1?void 0:a?Re(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let Dt=class extends z(w){constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}navigateToBadges(e){e.preventDefault(),this.navigate("/dashboard/badges")}render(){return l`
      <pg-header
        backUrl="/dashboard"
    ...
    `}};Ut=Be([f("pg-badges")],Ut);var Le=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,Q=(e,t,s,a)=>{for(var i=a>1?void 0:a?ze(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&Le(t,s,i),i};let B=class extends w{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.spritesheetUrl=window.jsObject.spritesheet_url,this.sliderElement=null,this.lastScrollLeft=0,this.scrollTimeout=null,this.badgeId="",this.badge={},this.currentBadgeIndex=0,this.currentBadge={}}connectedCallback(){super.connectedCallback();const e=window.jsObject.available_badges;this.badge=e.find(t=>t.id===this.badgeId),this.currentBadge=this.badge}firstUpdated(){if(this.badge.type!=="progression")return;const e=this.renderRoot.querySelector(".badge-slides");if(e){this.sliderElement=e;let t=null;for(let s=this.badge.progression_badges.length-1;s>=0;s--){const a=this.badge.progression_badges[s];if(a.has_earned_badge){t=a;break}}this.slideToEarnedBadge(t)}}getImageUrl(e){return e.has_earned_badge?e.image:e.bw_image}onSliderScroll(e){if(this.badge.type!=="progression"||!this.sliderElement)return;const t=5,s=.01;this.scrollTimeout=setTimeout(()=>{if(!this.sliderElement)return;const a=Math.abs((this.sliderElement.scrollLeft-this.lastScrollLeft)*(t/1e3));this.lastScrollLeft=this.sliderElement.scrollLeft,a<s&&this.setCurrentBadge()},t)}onSliderScrollEnd(e){this.scrollTimeout&&clearTimeout(this.scrollTimeout),this.setCurrentBadge()}slideToEarnedBadge(e){this.badge.type==="progression"&&this.sliderElement&&e&&this.sliderElement.scrollTo({left:this.sliderElement.scrollWidth*(this.badge.progression_badges.indexOf(e)/(this.badge.progression_badges.length+1))})}setCurrentBadge(){this.badge.type==="progression"&&this.sliderElement&&(this.currentBadgeIndex=Math.round(this.sliderElement.scrollLeft/this.sliderElement.scrollWidth*(this.badge.progression_badges.length+1)),this.currentBadge=this.badge.progression_badges[this.currentBadgeIndex])}render(){return l`
        <pg-header
    ...
    `}};Q([m({type:String})],B.prototype,"badgeId",2);Q([m({type:Object,attribute:!1})],B.prototype,"badge",2);Q([m({type:Number,attribute:!1})],B.prototype,"currentBadgeIndex",2);Q([m({type:Object,attribute:!1})],B.prototype,"currentBadge",2);B=Q([f("pg-badge-item")],B);var qe=Object.defineProperty,We=Object.getOwnPropertyDescriptor,ot=(e,t,s,a)=>{for(var i=a>1?void 0:a?We(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&qe(t,s,i),i};let Z=class extends w{constructor(){super(),this.translations=window.jsObject.translations,this.step="choose-option",this.type="",this.openInfo=""}createRelay(e){this.step="new-relay",this.type=e}onCancel(){this.step="choose-option"}getIcon(){return`${window.jsObject.spritesheet_url}#${this.type==="public"?"pg-world-light":"pg-private"}`}getTitle(){return this.type==="public"?this.translations.create_public_relay:this.translations.create_private_relay}async handleOpenInfo(e,t){e.stopImmediatePropagation(),this.openInfo!==t?this.openInfo=t:this.openInfo=""}handleNavigate(){location.href="/relays"}render(){return l`
      <pg-header
    ...
    `}};ot([g()],Z.prototype,"step",2);ot([g()],Z.prototype,"type",2);ot([g()],Z.prototype,"openInfo",2);Z=ot([f("pg-new-relay")],Z);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
