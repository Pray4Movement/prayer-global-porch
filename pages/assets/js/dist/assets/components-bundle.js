 ...
 */function y(s){return m({...s,state:!0,attribute:!1})}var se=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,Rt=(s,t,e,a)=>{for(var i=a>1?void 0:a?ie(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&se(t,e,i),i};let F=class extends C{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return u`
    ...
    `}};v([m({type:String})],f.prototype,"name",2);v([m({type:Number})],f.prototype,"lapNumber",2);v([m({type:Number})],f.prototype,"progress",2);v([m({type:Object})],f.prototype,"translations",2);v([m({type:String})],f.prototype,"spritesheetUrl",2);v([m({type:String})],f.prototype,"relayType",2);v([m({type:String})],f.prototype,"visibility",2);v([m({type:String})],f.prototype,"urlRoot",2);v([m({type:Boolean})],f.prototype,"hiddenRelay",2);f=v([E("pg-relay-item")],f);var le=Object.getOwnPropertyDescriptor,ce=(s,t,e,a)=>{for(var i=a>1?void 0:a?le(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let yt=class extends D{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return u`
