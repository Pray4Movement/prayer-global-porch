 ...
 */function g(s){return $({...s,state:!0,attribute:!1})}var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,zt=(s,t,e,a)=>{for(var i=a>1?void 0:a?pe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&de(t,e,i),i};let G=class extends E{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return h`
  ...
  `;Bt([$({type:String})],et.prototype,"href",2);et=Bt([b("nav-link")],et);var Oe=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,w=(s,t,e,a)=>{for(var i=a>1?void 0:a?xe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Oe(t,e,i),i};let f=class extends j{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.isOwner=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return h`
    ...
    `}};A([$({type:Boolean})],v.prototype,"edit",2);A([$({type:Object})],v.prototype,"relay",2);A([g()],v.prototype,"type",2);A([g()],v.prototype,"title",2);A([g()],v.prototype,"showAdvancedOptions",2);A([g()],v.prototype,"startDate",2);A([g()],v.prototype,"startTime",2);A([g()],v.prototype,"endDate",2);A([g()],v.prototype,"endTime",2);A([g()],v.prototype,"isSingle",2);v=A([b("pg-relay-form")],v);var Se=Object.getOwnPropertyDescriptor,Ee=(s,t,e,a)=>{for(var i=a>1?void 0:a?Se(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=n(i)||i);return i};let Ct=class extends j{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return h`
      <pg-header
        backUrl="/dashboard"
        ...
        <section class="stack-sm text-center">
          ...
          <div class="cluster s-sm align-items-center">
            <label class="h5 form-group" for="notifications-toggle">
              ...
              <input type="checkbox" role="switch" ?checked=${!0} id="notifications-toggle" />
            </label>
          </div>
