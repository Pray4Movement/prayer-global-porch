 ...
 */const q=globalThis,it=q.ShadowRoot&&(q.ShadyCSS===void 0||q.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,at=Symbol(),lt=new WeakMap;let xt=class{constructor(t,e,a){if(this._$cssResult$=!0,a!==at)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(it&&t===void 0){const a=e!==void 0&&e.length===1;a&&(t=lt.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&lt.set(e,t))}return t}toString(){return this.cssText}};const Rt=s=>new xt(typeof s=="string"?s:s+"",void 0,at),Et=(s,...t)=>{const e=s.length===1?s[0]:t.reduce((a,i,r)=>a+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+s[r+1],s[0]);return new xt(e,s,at)},Nt=(s,t)=>{if(it)s.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const e of t){const a=document.createElement("style"),i=q.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=e.cssText,s.appendChild(a)}},ct=it?s=>s:s=>s instanceof CSSStyleSheet?(t=>{let e="";for(const a of t.cssRules)e+=a.cssText;return Rt(e)})(s):s;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Dt,defineProperty:Ht,getOwnPropertyDescriptor:Mt,getOwnPropertyNames:zt,getOwnPropertySymbols:It,getPrototypeOf:Lt}=Object,A=globalThis,ht=A.trustedTypes,Bt=ht?ht.emptyScript:"",X=A.reactiveElementPolyfillSupport,z=(s,t)=>s,W={toAttribute(s,t){switch(t){case Boolean:s=s?Bt:null;break;case Object:case Array:s=s==null?s:JSON.stringify(s)}return s},fromAttribute(s,t){let e=s;switch(t){case Boolean:e=s!==null;break;case Number:e=s===null?null:Number(s);break;case Object:case Array:try{e=JSON.parse(s)}catch{e=null}}return e}},nt=(s,t)=>!Dt(s,t),dt={attribute:!0,type:String,converter:W,reflect:!1,hasChanged:nt};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),A.litPropertyMetadata??(A.litPropertyMetadata=new WeakMap);class U extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=dt){if(e.state&&(e.attribute=!1),this._$Ei(),this.elementProperties.set(t,e),!e.noAccessor){const a=Symbol(),i=this.getPropertyDescriptor(t,a,e);i!==void 0&&Ht(this.prototype,t,i)}}static getPropertyDescriptor(t,e,a){const{get:i,set:r}=Mt(this.prototype,t)??{get(){return this[e]},set(n){this[e]=n}};return{get(){return i==null?void 0:i.call(this)},set(n){const l=i==null?void 0:i.call(this);r.call(this,n),this.requestUpdate(t,l,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??dt}static _$Ei(){if(this.hasOwnProperty(z("elementProperties")))return;const t=Lt(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(z("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(z("properties"))){const e=this.properties,a=[...zt(e),...It(e)];for(const i of a)this.createProperty(i,e[i])}const t=this[Symbol.metadata];if(t!==null){const e=litPropertyMetadata.get(t);if(e!==void 0)for(const[a,i]of e)this.elementProperties.set(a,i)}this._$Eh=new Map;for(const[e,a]of this.elementProperties){const i=this._$Eu(e,a);i!==void 0&&this._$Eh.set(i,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const a=new Set(t.flat(1/0).reverse());for(const i of a)e.unshift(ct(i))}else t!==void 0&&e.push(ct(t));return e}static _$Eu(t,e){const a=e.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(e=>e(this))}addController(t){var e;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((e=t.hostConnected)==null||e.call(t))}removeController(t){var e;(e=this._$EO)==null||e.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const a of e.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Nt(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(e=>{var a;return(a=e.hostConnected)==null?void 0:a.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(e=>{var a;return(a=e.hostDisconnected)==null?void 0:a.call(e)})}attributeChangedCallback(t,e,a){this._$AK(t,a)}_$EC(t,e){var r;const a=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,a);if(i!==void 0&&a.reflect===!0){const n=(((r=a.converter)==null?void 0:r.toAttribute)!==void 0?a.converter:W).toAttribute(e,a.type);this._$Em=t,n==null?this.removeAttribute(i):this.setAttribute(i,n),this._$Em=null}}_$AK(t,e){var r;const a=this.constructor,i=a._$Eh.get(t);if(i!==void 0&&this._$Em!==i){const n=a.getPropertyOptions(i),l=typeof n.converter=="function"?{fromAttribute:n.converter}:((r=n.converter)==null?void 0:r.fromAttribute)!==void 0?n.converter:W;this._$Em=i,this[i]=l.fromAttribute(e,n.type),this._$Em=null}}requestUpdate(t,e,a){if(t!==void 0){if(a??(a=this.constructor.getPropertyOptions(t)),!(a.hasChanged??nt)(this[t],e))return;this.P(t,e,a)}this.isUpdatePending===!1&&(this._$ES=this._$ET())}P(t,e,a){this._$AL.has(t)||this._$AL.set(t,e),a.reflect===!0&&this._$Em!==t&&(this._$Ej??(this._$Ej=new Set)).add(t)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var a;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[r,n]of this._$Ep)this[r]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[r,n]of i)n.wrapped!==!0||this._$AL.has(r)||this[r]===void 0||this.P(r,this[r],n)}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),(a=this._$EO)==null||a.forEach(i=>{var r;return(r=i.hostUpdate)==null?void 0:r.call(i)}),this.update(e)):this._$EU()}catch(i){throw t=!1,this._$EU(),i}t&&this._$AE(e)}willUpdate(t){}_$AE(t){var e;(e=this._$EO)==null||e.forEach(a=>{var i;return(i=a.hostUpdated)==null?void 0:i.call(a)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Ej&&(this._$Ej=this._$Ej.forEach(e=>this._$EC(e,this[e]))),this._$EU()}updated(t){}firstUpdated(t){}}U.elementStyles=[],U.shadowRootOptions={mode:"open"},U[z("elementProperties")]=new Map,U[z("finalized")]=new Map,X==null||X({ReactiveElement:U}),(A.reactiveElementVersions??(A.reactiveElementVersions=[])).push("2.0.4");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const I=globalThis,J=I.trustedTypes,pt=J?J.createPolicy("lit-html",{createHTML:s=>s}):void 0,Ot="$lit$",w=`lit$${Math.random().toFixed(9).slice(2)}$`,St="?"+w,Vt=`<${St}>`,k=document,L=()=>k.createComment(""),B=s=>s===null||typeof s!="object"&&typeof s!="function",rt=Array.isArray,qt=s=>rt(s)||typeof(s==null?void 0:s[Symbol.iterator])=="function",G=`[ 	
\f\r]`,H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ut=/-->/g,gt=/>/g,S=RegExp(`>|${G}(?:([^\\s"'>=/]+)(${G}*=${G}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),mt=/'/g,_t=/"/g,Pt=/^(?:script|style|textarea|title)$/i,Wt=s=>(t,...e)=>({_$litType$:s,strings:t,values:e}),g=Wt(1),T=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),$t=new WeakMap,j=k.createTreeWalker(k,129);function jt(s,t){if(!rt(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return pt!==void 0?pt.createHTML(t):t}const Jt=(s,t)=>{const e=s.length-1,a=[];let i,r=t===2?"<svg>":t===3?"<math>":"",n=H;for(let l=0;l<e;l++){const o=s[l];let h,u,c=-1,p=0;for(;p<o.length&&(n.lastIndex=p,u=n.exec(o),u!==null);)p=n.lastIndex,n===H?u[1]==="!--"?n=ut:u[1]!==void 0?n=gt:u[2]!==void 0?(Pt.test(u[2])&&(i=RegExp("</"+u[2],"g")),n=S):u[3]!==void 0&&(n=S):n===S?u[0]===">"?(n=i??H,c=-1):u[1]===void 0?c=-2:(c=n.lastIndex-u[2].length,h=u[1],n=u[3]===void 0?S:u[3]==='"'?_t:mt):n===_t||n===mt?n=S:n===ut||n===gt?n=H:(n=S,i=void 0);const d=n===S&&s[l+1].startsWith("/>")?" ":"";r+=n===H?o+Vt:c>=0?(a.push(h),o.slice(0,c)+Ot+o.slice(c)+w+d):o+w+(c===-2?l:d)}return[jt(s,r+(s[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class V{constructor({strings:t,_$litType$:e},a){let i;this.parts=[];let r=0,n=0;const l=t.length-1,o=this.parts,[h,u]=Jt(t,e);if(this.el=V.createElement(h,a),j.currentNode=this.el.content,e===2||e===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(i=j.nextNode())!==null&&o.length<l;){if(i.nodeType===1){if(i.hasAttributes())for(const c of i.getAttributeNames())if(c.endsWith(Ot)){const p=u[n++],d=i.getAttribute(c).split(w),m=/([.?@])?(.*)/.exec(p);o.push({type:1,index:r,name:m[2],strings:d,ctor:m[1]==="."?Ft:m[1]==="?"?Kt:m[1]==="@"?Qt:K}),i.removeAttribute(c)}else c.startsWith(w)&&(o.push({type:6,index:r}),i.removeAttribute(c));if(Pt.test(i.tagName)){const c=i.textContent.split(w),p=c.length-1;if(p>0){i.textContent=J?J.emptyScript:"";for(let d=0;d<p;d++)i.append(c[d],L()),j.nextNode(),o.push({type:2,index:++r});i.append(c[p],L())}}}else if(i.nodeType===8)if(i.data===St)o.push({type:2,index:r});else{let c=-1;for(;(c=i.data.indexOf(w,c+1))!==-1;)o.push({type:7,index:r}),c+=w.length-1}r++}}static createElement(t,e){const a=k.createElement("template");return a.innerHTML=t,a}}function R(s,t,e=s,a){var n,l;if(t===T)return t;let i=a!==void 0?(n=e._$Co)==null?void 0:n[a]:e._$Cl;const r=B(t)?void 0:t._$litDirective$;return(i==null?void 0:i.constructor)!==r&&((l=i==null?void 0:i._$AO)==null||l.call(i,!1),r===void 0?i=void 0:(i=new r(s),i._$AT(s,e,a)),a!==void 0?(e._$Co??(e._$Co=[]))[a]=i:e._$Cl=i),i!==void 0&&(t=R(s,i._$AS(s,t.values),i,a)),t}let Zt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:a}=this._$AD,i=((t==null?void 0:t.creationScope)??k).importNode(e,!0);j.currentNode=i;let r=j.nextNode(),n=0,l=0,o=a[0];for(;o!==void 0;){if(n===o.index){let h;o.type===2?h=new N(r,r.nextSibling,this,t):o.type===1?h=new o.ctor(r,o.name,o.strings,this,t):o.type===6&&(h=new Xt(r,this,t)),this._$AV.push(h),o=a[++l]}n!==(o==null?void 0:o.index)&&(r=j.nextNode(),n++)}return j.currentNode=k,i}p(t){let e=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,e),e+=a.strings.length-2):a._$AI(t[e])),e++}};class N{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,e,a,i){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=a,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=R(this,t,e),B(t)?t===_||t==null||t===""?(this._$AH!==_&&this._$AR(),this._$AH=_):t!==this._$AH&&t!==T&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):qt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==_&&B(this._$AH)?this._$AA.nextSibling.data=t:this.T(k.createTextNode(t)),this._$AH=t}$(t){var r;const{values:e,_$litType$:a}=t,i=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=V.createElement(jt(a.h,a.h[0]),this.options)),a);if(((r=this._$AH)==null?void 0:r._$AD)===i)this._$AH.p(e);else{const n=new Zt(i,this),l=n.u(this.options);n.p(e),this.T(l),this._$AH=n}}_$AC(t){let e=$t.get(t.strings);return e===void 0&&$t.set(t.strings,e=new V(t)),e}k(t){rt(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let a,i=0;for(const r of t)i===e.length?e.push(a=new N(this.O(L()),this.O(L()),this,this.options)):a=e[i],a._$AI(r),i++;i<e.length&&(this._$AR(a&&a._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){var a;for((a=this._$AP)==null?void 0:a.call(this,!1,!0,e);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var e;this._$AM===void 0&&(this._$Cv=t,(e=this._$AP)==null||e.call(this,t))}}class K{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,a,i,r){this.type=1,this._$AH=_,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=r,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=_}_$AI(t,e=this,a,i){const r=this.strings;let n=!1;if(r===void 0)t=R(this,t,e,0),n=!B(t)||t!==this._$AH&&t!==T,n&&(this._$AH=t);else{const l=t;let o,h;for(t=r[0],o=0;o<r.length-1;o++)h=R(this,l[a+o],e,o),h===T&&(h=this._$AH[o]),n||(n=!B(h)||h!==this._$AH[o]),h===_?t=_:t!==_&&(t+=(h??"")+r[o+1]),this._$AH[o]=h}n&&!i&&this.j(t)}j(t){t===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ft extends K{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===_?void 0:t}}class Kt extends K{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==_)}}class Qt extends K{constructor(t,e,a,i,r){super(t,e,a,i,r),this.type=5}_$AI(t,e=this){if((t=R(this,t,e,0)??_)===T)return;const a=this._$AH,i=t===_&&a!==_||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,r=t!==_&&(a===_||i);i&&this.element.removeEventListener(this.name,this,a),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e;typeof this._$AH=="function"?this._$AH.call(((e=this.options)==null?void 0:e.host)??this.element,t):this._$AH.handleEvent(t)}}class Xt{constructor(t,e,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){R(this,t)}}const Gt={I:N},Y=I.litHtmlPolyfillSupport;Y==null||Y(V,N),(I.litHtmlVersions??(I.litHtmlVersions=[])).push("3.2.1");const Yt=(s,t,e)=>{const a=(e==null?void 0:e.renderBefore)??t;let i=a._$litPart$;if(i===void 0){const r=(e==null?void 0:e.renderBefore)??null;a._$litPart$=i=new N(t.insertBefore(L(),r),r,void 0,e??{})}return i._$AI(s),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let C=class extends U{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e;const t=super.createRenderRoot();return(e=this.renderOptions).renderBefore??(e.renderBefore=t.firstChild),t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Yt(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return T}};var At;C._$litElement$=!0,C.finalized=!0,(At=globalThis.litElementHydrateSupport)==null||At.call(globalThis,{LitElement:C});const tt=globalThis.litElementPolyfillSupport;tt==null||tt({LitElement:C});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.1.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function E(s){return $({...s,state:!0,attribute:!1})}var se=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,Ct=(s,t,e,a)=>{for(var i=a>1?void 0:a?ie(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&se(t,e,i),i};let Z=class extends C{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return g`
      <div class="circle">
    ...
    `];Ct([$({type:String})],Z.prototype,"text",2);Z=Ct([x("pg-avatar")],Z);var ae=Object.defineProperty,ne=Object.getOwnPropertyDescriptor,kt=(s,t,e,a)=>{for(var i=a>1?void 0:a?ne(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&ae(t,e,i),i};let F=class extends C{constructor(){super(...arguments),this.open=!1,this.modalId=this.generateId()}generateId(){return Array(6).fill("").map(()=>String.fromCharCode(97+Math.floor(Math.random()*26))).join("")}render(){return g`
      <div
    ...
    `];kt([$({type:Boolean})],F.prototype,"open",2);F=kt([x("pg-modal")],F);class D extends C{constructor(){super()}createRenderRoot(){return this}}var re=Object.defineProperty,oe=Object.getOwnPropertyDescriptor,y=(s,t,e,a)=>{for(var i=a>1?void 0:a?oe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&re(t,e,i),i};let f=class extends D{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return g`
      <svg>
        <use href="${this.spritesheetUrl}#${t}"></use>
      </svg>
    `}render(){const s=this.relayType==="custom"?this.visibility:this.relayType;return g`
    ...
    `}};y([$({type:String})],f.prototype,"name",2);y([$({type:Number})],f.prototype,"lapNumber",2);y([$({type:Number})],f.prototype,"progress",2);y([$({type:Object})],f.prototype,"translations",2);y([$({type:String})],f.prototype,"spritesheetUrl",2);y([$({type:String})],f.prototype,"relayType",2);y([$({type:String})],f.prototype,"visibility",2);y([$({type:String})],f.prototype,"urlRoot",2);f=y([x("pg-relay-item")],f);var le=Object.getOwnPropertyDescriptor,ce=(s,t,e,a)=>{for(var i=a>1?void 0:a?le(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let ft=class extends D{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return g`
              ...
              <section class="user__summary stack-sm">
                ...
                <div class="user__info text-center">
                  ...
                  <div class="user__location">
                    ...
                    ${this.user.location&&this.user.location.label||g`<span class="loading-spinner active"></span>`}
                    </div>
                    ${this.user.location&&this.user.location.source==="ip"?g`
                            <span
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:be}=Gt,bt=()=>document.createComment(""),M=(s,t,e)=>{var r;const a=s._$AA.parentNode,i=t===void 0?s._$AB:t._$AA;if(e===void 0){const n=a.insertBefore(bt(),i),l=a.insertBefore(bt(),i);e=new be(n,l,s,s.options)}else{const n=e._$AB.nextSibling,l=e._$AM,o=l!==s;if(o){let h;(r=e._$AQ)==null||r.call(e,s),e._$AM=s,e._$AP!==void 0&&(h=s._$AU)!==l._$AU&&e._$AP(h)}if(n!==i||o){let h=e._$AA;for(;h!==n;){const u=h.nextSibling;a.insertBefore(h,i),h=u}}}return e},P=(s,t,e=s)=>(s._$AI(t,e),s),ye={},we=(s,t=ye)=>s._$AH=t,Ae=s=>s._$AH,et=s=>{var a;(a=s._$AP)==null||a.call(s,!1,!0);let t=s._$AA;const e=s._$AB.nextSibling;for(;t!==e;){const i=t.nextSibling;t.remove(),t=i}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const yt=(s,t,e)=>{const a=new Map;for(let i=t;i<=e;i++)a.set(s[i],i);return a},xe=fe(class extends ve{constructor(s){if(super(s),s.type!==$e.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let a;e===void 0?e=t:t!==void 0&&(a=t);const i=[],r=[];let n=0;for(const l of s)i[n]=a?a(l,n):n,r[n]=e(l,n),n++;return{values:r,keys:i}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,a]){const i=Ae(s),{values:r,keys:n}=this.dt(t,e,a);if(!Array.isArray(i))return this.ut=n,r;const l=this.ut??(this.ut=[]),o=[];let h,u,c=0,p=i.length-1,d=0,m=r.length-1;for(;c<=p&&d<=m;)if(i[c]===null)c++;else if(i[p]===null)p--;else if(l[c]===n[d])o[d]=P(i[c],r[d]),c++,d++;else if(l[p]===n[m])o[m]=P(i[p],r[m]),p--,m--;else if(l[c]===n[m])o[m]=P(i[c],r[m]),M(s,o[m+1],i[c]),c++,m--;else if(l[p]===n[d])o[d]=P(i[p],r[d]),M(s,i[c],i[p]),p--,d++;else if(h===void 0&&(h=yt(n,d,m),u=yt(l,c,p)),h.has(l[c]))if(h.has(l[p])){const v=u.get(n[d]),Q=v!==void 0?i[v]:null;if(Q===null){const ot=M(s,i[c]);P(ot,r[d]),o[d]=ot}else o[d]=P(Q,r[d]),M(s,i[c],Q),i[v]=null;d++}else et(i[p]),p--;else et(i[c]),c++;for(;d<=m;){const v=M(s,o[m+1]);P(v,r[d]),o[d++]=v}for(;c<=p;){const v=i[c++];v!==null&&et(v)}return this.ut=n,we(s,o),T}});var Ee=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,Ut=(s,t,e,a)=>{for(var i=a>1?void 0:a?Oe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Ee(t,e,i),i};let st=class extends D{constructor(){super(),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.relays=[],fetch(window.pg_global.root+"pg-api/v1/profile/relays",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce},body:JSON.stringify({data:{user_id:this.user.id}})}).then(s=>s.json()).then(s=>{const{relays:t,hidden_relays:e}=s;this.relays=t})}render(){return g`
      <div class="offcanvas__header align-items-center lh-sm">
        <button type="button" class="me-auto" @click=${()=>history.back()}>
          <i class="icon pg-chevron-left two-em"></i>
        </button>
      ...
      <div class="white-bg page px-3">
        <div class="pg-container stack-md" data-small data-stretch>
          <div role="list" class="stack-md relay-list" data-stretch>
            ${xe(this.relays,s=>s.post_title,s=>g`
                <pg-relay-item
                  name="${s.post_title}"
                  ...
                  .translations="${{lap:this.translations.lap,pray:this.translations.pray,map:this.translations.map,share:this.translations.share,display:this.translations.display,edit:this.translations.edit,remove:this.translations.remove}}"
      ...
      <div class="pg-container stack-md page">
        ...
        <section class="stack-sm">
          ...
          >
            ...
            ${this.subscribing?g` <span class="loading-spinner active"></span> `:""}
          </button>
        </section>
        ...
        <div slot="body">
          <div class="stack-sm align-items-stretch">
            ...
            <label for="language">
              ...
              >
                ${Object.entries(window.jsObject.languages).map(([t,e])=>g`
                    <option
                      value=${t}
    ...
    `}};O([E()],b.prototype,"showEditAccount",2);O([E()],b.prototype,"saving",2);O([E()],b.prototype,"name",2);O([E()],b.prototype,"showDeleteAccount",2);O([E()],b.prototype,"deleteInputValue",2);O([E()],b.prototype,"subscribing",2);O([E()],b.prototype,"subscribed",2);b=O([x("pg-settings")],b);
