 ...
 */function g(s){return $({...s,state:!0,attribute:!1})}var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,zt=(s,t,e,a)=>{for(var i=a>1?void 0:a?pe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&de(t,e,i),i};let G=class extends E{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return h`
    ...
    `}};yt([$({type:String})],Y.prototype,"title",2);yt([$({type:String})],Y.prototype,"backUrl",2);Y=yt([v("pg-header")],Y);var ve=Object.defineProperty,be=Object.getOwnPropertyDescriptor,Lt=(s,t,e,a)=>{for(var i=a>1?void 0:a?be(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&ve(t,e,i),i};let tt=class extends E{constructor(){super(...arguments),this.open=!1,this.modalId=this.generateId()}generateId(){return Array(6).fill("").map(()=>String.fromCharCode(97+Math.floor(Math.random()*26))).join("")}render(){return h`
      <div
  ...
  `;Bt([$({type:String})],et.prototype,"href",2);et=Bt([v("nav-link")],et);var Oe=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,A=(s,t,e,a)=>{for(var i=a>1?void 0:a?xe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Oe(t,e,i),i};let b=class extends j{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return h`
    ...
    `}};w([$({type:Boolean})],f.prototype,"edit",2);w([$({type:Object})],f.prototype,"relay",2);w([g()],f.prototype,"type",2);w([g()],f.prototype,"title",2);w([g()],f.prototype,"showAdvancedOptions",2);w([g()],f.prototype,"startDate",2);w([g()],f.prototype,"startTime",2);w([g()],f.prototype,"endDate",2);w([g()],f.prototype,"endTime",2);w([g()],f.prototype,"isSingle",2);f=w([v("pg-relay-form")],f);var Se=Object.getOwnPropertyDescriptor,Ee=(s,t,e,a)=>{for(var i=a>1?void 0:a?Se(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let Ct=class extends j{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return h`
      <pg-header
        backUrl="/dashboard"
 ...
 */const Tt=(s,t,e)=>{const a=new Map;for(let i=t;i<=e;i++)a.set(s[i],i);return a},Le=Ue(class extends Ie{constructor(s){if(super(s),s.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let a;e===void 0?e=t:t!==void 0&&(a=t);const i=[],r=[];let n=0;for(const l of s)i[n]=a?a(l,n):n,r[n]=e(l,n),n++;return{values:r,keys:i}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,a]){const i=ze(s),{values:r,keys:n}=this.dt(t,e,a);if(!Array.isArray(i))return this.ut=n,r;const l=this.ut??(this.ut=[]),o=[];let d,p,c=0,_=i.length-1,u=0,m=r.length-1;for(;c<=_&&u<=m;)if(i[c]===null)c++;else if(i[_]===null)_--;else if(l[c]===n[u])o[u]=R(i[c],r[u]),c++,u++;else if(l[_]===n[m])o[m]=R(i[_],r[m]),_--,m--;else if(l[c]===n[m])o[m]=R(i[c],r[m]),B(s,o[m+1],i[c]),c++,m--;else if(l[_]===n[u])o[u]=R(i[_],r[u]),B(s,i[c],i[_]),_--,u++;else if(d===void 0&&(d=Tt(n,u,m),p=Tt(l,c,_)),d.has(l[c]))if(d.has(l[_])){const O=p.get(n[u]),nt=O!==void 0?i[O]:null;if(nt===null){const ft=B(s,i[c]);R(ft,r[u]),o[u]=ft}else o[u]=R(nt,r[u]),B(s,i[c],nt),i[O]=null;u++}else ht(i[_]),_--;else ht(i[c]),c++;for(;u<=m;){const O=B(s,o[m+1]);R(O,r[u]),o[u++]=O}for(;c<=_;){const O=i[c++];O!==null&&ht(O)}return this.ut=n,He(s,o),I}});var Be=Object.defineProperty,qe=Object.getOwnPropertyDescriptor,N=(s,t,e,a)=>{for(var i=a>1?void 0:a?qe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Be(t,e,i),i};let C=class extends j{constructor(){super(),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.relays=[],this.hiddenRelays=[],this.showHiddenRelays=!1,this.loading=!0,this.editRelayModalOpen=!1,this.editRelay=null,fetch(window.pg_global.root+"pg-api/v1/dashboard/relays",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce},body:JSON.stringify({data:{user_id:this.user.id}})}).then(s=>s.json()).then(s=>{const{relays:t,hidden_relays:e}=s;this.relays=t,this.hiddenRelays=e}).finally(()=>{this.loading=!1})}async handleHide(s){(await fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/hide?relay_id=${s.post_id}`,{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce}})).ok&&(this.hiddenRelays=[...this.hiddenRelays,s.post_id])}async handleUnhide(s){await window.api_fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/unhide?relay_id=${s.post_id}`,{method:"POST"}),this.hiddenRelays=this.hiddenRelays.filter(t=>t!==s.post_id),console.log(this.hiddenRelays)}openEditRelayModal(s){this.editRelayModalOpen=!0,this.editRelay=this.relays.find(t=>t.post_id===s)||null}toggleHiddenRelays(){this.showHiddenRelays=!this.showHiddenRelays}closeModal(s){this.editRelayModalOpen=!1}render(){var s;return h`
    ...
    `}};k([g()],x.prototype,"showEditAccount",2);k([g()],x.prototype,"saving",2);k([g()],x.prototype,"name",2);k([g()],x.prototype,"showDeleteAccount",2);k([g()],x.prototype,"deleteInputValue",2);k([g()],x.prototype,"subscribing",2);k([g()],x.prototype,"subscribed",2);x=k([v("pg-settings")],x);
