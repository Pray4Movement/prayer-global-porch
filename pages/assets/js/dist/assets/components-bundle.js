 ...
 */function g(s){return y({...s,state:!0,attribute:!1})}var de=Object.defineProperty,he=Object.getOwnPropertyDescriptor,Nt=(s,t,e,a)=>{for(var i=a>1?void 0:a?he(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&de(t,e,i),i};let G=class extends S{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return d`
  ...
  `;Lt([y({type:String})],tt.prototype,"href",2);tt=Lt([f("nav-link")],tt);var Ae=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,A=(s,t,e,a)=>{for(var i=a>1?void 0:a?xe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Ae(t,e,i),i};let b=class extends j{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return d`
    ...
    `}};st([g()],K.prototype,"step",2);st([g()],K.prototype,"type",2);st([g()],K.prototype,"openInfo",2);K=st([f("pg-new-relay")],K);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ke={CHILD:2},De=s=>(...t)=>({_$litDirective$:s,values:t});class Ue{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,a){this._$Ct=t,this._$AM=e,this._$Ci=a}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Ie}=re,Et=()=>document.createComment(""),B=(s,t,e)=>{var r;const a=s._$AA.parentNode,i=t===void 0?s._$AB:t._$AA;if(e===void 0){const n=a.insertBefore(Et(),i),l=a.insertBefore(Et(),i);e=new Ie(n,l,s,s.options)}else{const n=e._$AB.nextSibling,l=e._$AM,o=l!==s;if(o){let h;(r=e._$AQ)==null||r.call(e,s),e._$AM=s,e._$AP!==void 0&&(h=s._$AU)!==l._$AU&&e._$AP(h)}if(n!==i||o){let h=e._$AA;for(;h!==n;){const m=h.nextSibling;a.insertBefore(h,i),h=m}}}return e},k=(s,t,e=s)=>(s._$AI(t,e),s),Ne={},Me=(s,t=Ne)=>s._$AH=t,He=s=>s._$AH,lt=s=>{var a;(a=s._$AP)==null||a.call(s,!1,!0);let t=s._$AA;const e=s._$AB.nextSibling;for(;t!==e;){const i=t.nextSibling;t.remove(),t=i}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const St=(s,t,e)=>{const a=new Map;for(let i=t;i<=e;i++)a.set(s[i],i);return a},ze=De(class extends Ue{constructor(s){if(super(s),s.type!==ke.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let a;e===void 0?e=t:t!==void 0&&(a=t);const i=[],r=[];let n=0;for(const l of s)i[n]=a?a(l,n):n,r[n]=e(l,n),n++;return{values:r,keys:i}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,a]){const i=He(s),{values:r,keys:n}=this.dt(t,e,a);if(!Array.isArray(i))return this.ut=n,r;const l=this.ut??(this.ut=[]),o=[];let h,m,c=0,u=i.length-1,p=0,_=r.length-1;for(;c<=u&&p<=_;)if(i[c]===null)c++;else if(i[u]===null)u--;else if(l[c]===n[p])o[p]=k(i[c],r[p]),c++,p++;else if(l[u]===n[_])o[_]=k(i[u],r[_]),u--,_--;else if(l[c]===n[_])o[_]=k(i[c],r[_]),B(s,o[_+1],i[c]),c++,_--;else if(l[u]===n[p])o[p]=k(i[u],r[p]),B(s,i[c],i[u]),u--,p++;else if(h===void 0&&(h=St(n,p,_),m=St(l,c,u)),h.has(l[c]))if(h.has(l[u])){const x=m.get(n[p]),it=x!==void 0?i[x]:null;if(it===null){const mt=B(s,i[c]);k(mt,r[p]),o[p]=mt}else o[p]=k(it,r[p]),B(s,i[c],it),i[x]=null;p++}else lt(i[u]),u--;else lt(i[c]),c++;for(;p<=_;){const x=B(s,o[_+1]);k(x,r[p]),o[p++]=x}for(;c<=u;){const x=i[c++];x!==null&&lt(x)}return this.ut=n,Me(s,o),I}});var Le=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,N=(s,t,e,a)=>{for(var i=a>1?void 0:a?Be(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Le(t,e,i),i};let C=class extends j{constructor(){super(),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.relays=[],this.hiddenRelays=[],this.showHiddenRelays=!1,this.loading=!0,this.editRelayModalOpen=!1,this.editRelay=null,fetch(window.pg_global.root+"pg-api/v1/dashboard/relays",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce},body:JSON.stringify({data:{user_id:this.user.id}})}).then(s=>s.json()).then(s=>{const{relays:t,hidden_relays:e}=s;this.relays=t,this.hiddenRelays=e}).finally(()=>{this.loading=!1})}async handleHide(s){(await fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/hide?relay_id=${s.post_id}`,{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce}})).ok&&(this.hiddenRelays=[...this.hiddenRelays,s.post_id])}async handleUnhide(s){await window.api_fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/unhide?relay_id=${s.post_id}`,{method:"POST"}),this.hiddenRelays=this.hiddenRelays.filter(t=>t!==s.post_id),console.log(this.hiddenRelays)}openEditRelayModal(s){this.editRelayModalOpen=!0,this.editRelay=this.relays.find(t=>t.post_id===s)||null}toggleHiddenRelays(){this.showHiddenRelays=!this.showHiddenRelays}closeModal(s){this.editRelayModalOpen=!1}render(){var s;return d`
