 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function P(a){return _({...a,state:!0,attribute:!1})}var Jt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,wt=(a,t,e,i)=>{for(var s=i>1?void 0:i?Ft(t,e):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Jt(t,e,s),s};let q=class extends O{constructor(){super(...arguments),this.text=""}updated(a){a.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(a){const t=a.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return p`
      <div class="circle">
    ...
    `];At([_({type:Boolean})],W.prototype,"open",2);W=At([y("pg-modal")],W);class T extends O{constructor(){super()}createRenderRoot(){return this}}var Gt=Object.defineProperty,Qt=Object.getOwnPropertyDescriptor,j=(a,t,e,i)=>{for(var s=i>1?void 0:i?Qt(t,e):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Gt(t,e,s),s};let v=class extends T{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={private:"pg-private",public:"pg-world-light",global:"pg-logo-prayer"}[this.relayType]||"pg-logo-prayer";return p`
      <svg>
    ...
    `}};j([_({type:String})],v.prototype,"name",2);j([_({type:Number})],v.prototype,"lapNumber",2);j([_({type:Number})],v.prototype,"progress",2);j([_({type:Object})],v.prototype,"translations",2);j([_({type:String})],v.prototype,"spritesheetUrl",2);j([_({type:String})],v.prototype,"relayType",2);v=j([y("pg-relay-item")],v);var Xt=Object.getOwnPropertyDescriptor,Yt=(a,t,e,i)=>{for(var s=i>1?void 0:i?Xt(t,e):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(s)||s);return s};let dt=class extends T{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return p`
    ...
    `}};pt=re([y("pg-dashboard")],pt);var oe=Object.getOwnPropertyDescriptor,le=(a,t,e,i)=>{for(var s=i>1?void 0:i?oe(t,e):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(s)||s);return s};let ut=class extends T{constructor(){super(),this.user=window.pg_global.user,this.translations=window.jsObject.translations,fetch(window.pg_global.root+"pg-api/v1/profile/relays",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce},body:JSON.stringify({data:{user_id:this.user.id}})}).then(a=>a.json()).then(a=>{console.log(a)})}render(){return p`
      <div class="offcanvas__header align-items-center lh-sm">
        <button type="button" class="me-auto" @click=${()=>history.back()}>
          <i class="icon pg-chevron-left two-em"></i>
        </button>
