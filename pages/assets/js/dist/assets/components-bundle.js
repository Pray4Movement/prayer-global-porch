 ...
 */function g(s){return $({...s,state:!0,attribute:!1})}var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,zt=(s,t,e,a)=>{for(var i=a>1?void 0:a?pe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&de(t,e,i),i};let G=class extends C{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return h`
    ...
    `}};yt([$({type:String})],Y.prototype,"title",2);yt([$({type:String})],Y.prototype,"backUrl",2);Y=yt([b("pg-header")],Y);var ve=Object.defineProperty,be=Object.getOwnPropertyDescriptor,Lt=(s,t,e,a)=>{for(var i=a>1?void 0:a?be(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&ve(t,e,i),i};let tt=class extends C{constructor(){super(...arguments),this.open=!1,this.modalId=this.generateId()}generateId(){return Array(6).fill("").map(()=>String.fromCharCode(97+Math.floor(Math.random()*26))).join("")}render(){return h`
      <div
  ...
  `;Bt([$({type:String})],et.prototype,"href",2);et=Bt([b("nav-link")],et);var Oe=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,w=(s,t,e,a)=>{for(var i=a>1?void 0:a?xe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Oe(t,e,i),i};let f=class extends P{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.isOwner=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return h`
    ...
    `}};A([$({type:Boolean})],v.prototype,"edit",2);A([$({type:Object})],v.prototype,"relay",2);A([g()],v.prototype,"type",2);A([g()],v.prototype,"title",2);A([g()],v.prototype,"showAdvancedOptions",2);A([g()],v.prototype,"startDate",2);A([g()],v.prototype,"startTime",2);A([g()],v.prototype,"endDate",2);A([g()],v.prototype,"endTime",2);A([g()],v.prototype,"isSingle",2);v=A([b("pg-relay-form")],v);var Se=Object.getOwnPropertyDescriptor,Ee=(s,t,e,a)=>{for(var i=a>1?void 0:a?Se(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=n(i)||i);return i};let Ct=class extends P{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return h`
      <pg-header
        backUrl="/dashboard"
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Tt=(s,t,e)=>{const a=new Map;for(let i=t;i<=e;i++)a.set(s[i],i);return a},Le=Ue(class extends Ne{constructor(s){if(super(s),s.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let a;e===void 0?e=t:t!==void 0&&(a=t);const i=[],o=[];let n=0;for(const l of s)i[n]=a?a(l,n):n,o[n]=e(l,n),n++;return{values:o,keys:i}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,a]){const i=ze(s),{values:o,keys:n}=this.dt(t,e,a);if(!Array.isArray(i))return this.ut=n,o;const l=this.ut??(this.ut=[]),r=[];let d,p,c=0,_=i.length-1,u=0,m=o.length-1;for(;c<=_&&u<=m;)if(i[c]===null)c++;else if(i[_]===null)_--;else if(l[c]===n[u])r[u]=R(i[c],o[u]),c++,u++;else if(l[_]===n[m])r[m]=R(i[_],o[m]),_--,m--;else if(l[c]===n[m])r[m]=R(i[c],o[m]),B(s,r[m+1],i[c]),c++,m--;else if(l[_]===n[u])r[u]=R(i[_],o[u]),B(s,i[c],i[_]),_--,u++;else if(d===void 0&&(d=Tt(n,u,m),p=Tt(l,c,_)),d.has(l[c]))if(d.has(l[_])){const x=p.get(n[u]),nt=x!==void 0?i[x]:null;if(nt===null){const ft=B(s,i[c]);R(ft,o[u]),r[u]=ft}else r[u]=R(nt,o[u]),B(s,i[c],nt),i[x]=null;u++}else ht(i[_]),_--;else ht(i[c]),c++;for(;u<=m;){const x=B(s,r[m+1]);R(x,o[u]),r[u++]=x}for(;c<=_;){const x=i[c++];x!==null&&ht(x)}return this.ut=n,He(s,r),N}});var Be=Object.defineProperty,qe=Object.getOwnPropertyDescriptor,I=(s,t,e,a)=>{for(var i=a>1?void 0:a?qe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Be(t,e,i),i};let k=class extends P{constructor(){super(),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.relays=[],this.hiddenRelays=[],this.showHiddenRelays=!1,this.loading=!0,this.editRelayModalOpen=!1,this.editRelay=null,fetch(window.pg_global.root+"pg-api/v1/dashboard/relays",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce},body:JSON.stringify({data:{user_id:this.user.id}})}).then(s=>s.json()).then(s=>{const{relays:t,hidden_relays:e}=s;this.relays=t,this.hiddenRelays=e}).finally(()=>{this.loading=!1})}async handleHide(s){(await fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/hide?relay_id=${s.post_id}`,{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce}})).ok&&(this.hiddenRelays=[...this.hiddenRelays,s.post_id])}async handleUnhide(s){await window.api_fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/unhide?relay_id=${s.post_id}`,{method:"POST"}),this.hiddenRelays=this.hiddenRelays.filter(t=>t!==s.post_id)}openEditRelayModal(s){this.editRelayModalOpen=!0,this.editRelay=this.relays.find(t=>t.post_id===s)||null}toggleHiddenRelays(){this.showHiddenRelays=!this.showHiddenRelays}closeModal(s){this.editRelayModalOpen=!1}render(){var s;return h`
      <pg-header
        backUrl="/dashboard"
    ...
    `}};j([g()],O.prototype,"showEditAccount",2);j([g()],O.prototype,"saving",2);j([g()],O.prototype,"name",2);j([g()],O.prototype,"showDeleteAccount",2);j([g()],O.prototype,"deleteInputValue",2);j([g()],O.prototype,"subscribing",2);j([g()],O.prototype,"subscribed",2);j([g()],O.prototype,"hasNotificationsPermission",2);O=j([b("pg-settings")],O);
