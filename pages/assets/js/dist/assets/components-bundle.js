 ...
 */function u(s){return $({...s,state:!0,attribute:!1})}var he=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,zt=(s,t,e,a)=>{for(var i=a>1?void 0:a?pe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&he(t,e,i),i};let G=class extends E{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return d`
    ...
    `}};yt([$({type:String})],Y.prototype,"title",2);yt([$({type:String})],Y.prototype,"backUrl",2);Y=yt([f("pg-header")],Y);var fe=Object.defineProperty,be=Object.getOwnPropertyDescriptor,Lt=(s,t,e,a)=>{for(var i=a>1?void 0:a?be(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&fe(t,e,i),i};let tt=class extends E{constructor(){super(...arguments),this.open=!1,this.modalId=this.generateId()}generateId(){return Array(6).fill("").map(()=>String.fromCharCode(97+Math.floor(Math.random()*26))).join("")}render(){return d`
      <div
  ...
  `;Bt([$({type:String})],et.prototype,"href",2);et=Bt([f("nav-link")],et);var xe=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,A=(s,t,e,a)=>{for(var i=a>1?void 0:a?Oe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&xe(t,e,i),i};let b=class extends j{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return d`
    ...
    `}};w([$({type:Boolean})],v.prototype,"edit",2);w([$({type:Object})],v.prototype,"relay",2);w([u()],v.prototype,"type",2);w([u()],v.prototype,"title",2);w([u()],v.prototype,"showAdvancedOptions",2);w([u()],v.prototype,"startDate",2);w([u()],v.prototype,"startTime",2);w([u()],v.prototype,"endDate",2);w([u()],v.prototype,"endTime",2);w([u()],v.prototype,"isSingle",2);v=w([f("pg-relay-form")],v);var Se=Object.getOwnPropertyDescriptor,Ee=(s,t,e,a)=>{for(var i=a>1?void 0:a?Se(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let Ct=class extends j{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return d`
      <pg-header
        backUrl="/dashboard"
    ...
    `}};$t([u()],st.prototype,"relays",2);$t([u()],st.prototype,"loading",2);st=$t([f("pg-dashboard")],st);var ke=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,at=(s,t,e,a)=>{for(var i=a>1?void 0:a?Re(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&ke(t,e,i),i};let K=class extends j{constructor(){super(),this.translations=window.jsObject.translations,this.step="choose-option",this.type="",this.openInfo=""}createRelay(s){this.step="new-relay",this.type=s}onCancel(){this.step="choose-option"}getIcon(){return`${window.jsObject.spritesheet_url}#${this.type==="public"?"pg-world-light":"pg-private"}`}getTitle(){return this.type==="public"?this.translations.create_public_relay:this.translations.create_private_relay}async handleOpenInfo(s,t){s.stopImmediatePropagation(),this.openInfo!==t?this.openInfo=t:this.openInfo=""}handleNavigate(){location.href="/relays"}render(){return d`
      <pg-header
    ...
    `}};at([u()],K.prototype,"step",2);at([u()],K.prototype,"type",2);at([u()],K.prototype,"openInfo",2);K=at([f("pg-new-relay")],K);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const kt=(s,t,e)=>{const a=new Map;for(let i=t;i<=e;i++)a.set(s[i],i);return a},Le=Ue(class extends Ie{constructor(s){if(super(s),s.type!==De.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,t,e){let a;e===void 0?e=t:t!==void 0&&(a=t);const i=[],r=[];let n=0;for(const l of s)i[n]=a?a(l,n):n,r[n]=e(l,n),n++;return{values:r,keys:i}}render(s,t,e){return this.dt(s,t,e).values}update(s,[t,e,a]){const i=ze(s),{values:r,keys:n}=this.dt(t,e,a);if(!Array.isArray(i))return this.ut=n,r;const l=this.ut??(this.ut=[]),o=[];let h,m,c=0,g=i.length-1,p=0,_=r.length-1;for(;c<=g&&p<=_;)if(i[c]===null)c++;else if(i[g]===null)g--;else if(l[c]===n[p])o[p]=R(i[c],r[p]),c++,p++;else if(l[g]===n[_])o[_]=R(i[g],r[_]),g--,_--;else if(l[c]===n[_])o[_]=R(i[c],r[_]),B(s,o[_+1],i[c]),c++,_--;else if(l[g]===n[p])o[p]=R(i[g],r[p]),B(s,i[c],i[g]),g--,p++;else if(h===void 0&&(h=kt(n,p,_),m=kt(l,c,g)),h.has(l[c]))if(h.has(l[g])){const x=m.get(n[p]),nt=x!==void 0?i[x]:null;if(nt===null){const vt=B(s,i[c]);R(vt,r[p]),o[p]=vt}else o[p]=R(nt,r[p]),B(s,i[c],nt),i[x]=null;p++}else dt(i[g]),g--;else dt(i[c]),c++;for(;p<=_;){const x=B(s,o[_+1]);R(x,r[p]),o[p++]=x}for(;c<=g;){const x=i[c++];x!==null&&dt(x)}return this.ut=n,He(s,o),I}});var Be=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,N=(s,t,e,a)=>{for(var i=a>1?void 0:a?Ve(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Be(t,e,i),i};let C=class extends j{constructor(){super(),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.relays=[],this.hiddenRelays=[],this.showHiddenRelays=!1,this.loading=!0,this.editRelayModalOpen=!1,this.editRelay=null,fetch(window.pg_global.root+"pg-api/v1/dashboard/relays",{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce},body:JSON.stringify({data:{user_id:this.user.id}})}).then(s=>s.json()).then(s=>{const{relays:t,hidden_relays:e}=s;this.relays=t,this.hiddenRelays=e}).finally(()=>{this.loading=!1})}async handleHide(s){(await fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/hide?relay_id=${s.post_id}`,{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":window.pg_global.nonce}})).ok&&(this.hiddenRelays=[...this.hiddenRelays,s.post_id])}async handleUnhide(s){await window.api_fetch(`${window.pg_global.root}pg-api/v1/dashboard/relays/unhide?relay_id=${s.post_id}`,{method:"POST"}),this.hiddenRelays=this.hiddenRelays.filter(t=>t!==s.post_id),console.log(this.hiddenRelays)}openEditRelayModal(s){this.editRelayModalOpen=!0,this.editRelay=this.relays.find(t=>t.post_id===s)||null}toggleHiddenRelays(){this.showHiddenRelays=!this.showHiddenRelays}closeModal(s){this.editRelayModalOpen=!1}render(){var s;return d`
    ...
    `}};T([u()],O.prototype,"showEditAccount",2);T([u()],O.prototype,"saving",2);T([u()],O.prototype,"name",2);T([u()],O.prototype,"showDeleteAccount",2);T([u()],O.prototype,"deleteInputValue",2);T([u()],O.prototype,"subscribing",2);T([u()],O.prototype,"subscribed",2);O=T([f("pg-settings")],O);
