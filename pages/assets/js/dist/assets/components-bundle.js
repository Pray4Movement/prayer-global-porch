        ...
        <div class="pg-container">
          <div class="stack-sm badge-item" data-grid data-small>
            <div class="badge-item__timestamp" ?data-empty=${!this.currentBadge.timestamp}>
              ${this.currentBadge.retroactive?l`
                Earned retroactively ${this.currentBadge.timestamp?`${new Intl.DateTimeFormat().format(this.currentBadge.timestamp*1e3)}`:""}
              `:l`
