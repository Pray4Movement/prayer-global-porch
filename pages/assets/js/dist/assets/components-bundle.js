 ...
 */function E(a){return X({...a,state:!0,attribute:!1})}var qt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,vt=(a,t,e,i)=>{for(var s=i>1?void 0:i?Wt(t,e):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&qt(t,e,s),s};let L=class extends w{constructor(){super(...arguments),this.text=""}updated(a){a.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(a){const t=a.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return p`
    ...
    `}};ht=se([x("pg-dashboard")],ht);var ie=Object.getOwnPropertyDescriptor,ae=(a,t,e,i)=>{for(var s=i>1?void 0:i?ie(t,e):t,r=a.length-1,n;r>=0;r--)(n=a[r])&&(s=n(s)||s);return s};let dt=class extends H{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return p`
      <div class="offcanvas__header align-items-center lh-sm">
        <button type="button" class="me-auto" @click=${()=>history.back()}>
          <i class="icon pg-chevron-left two-em"></i>
        </button>
    ...
    `}};b([E()],m.prototype,"showEditAccount",2);b([E()],m.prototype,"saving",2);b([E()],m.prototype,"name",2);b([E()],m.prototype,"showDeleteAccount",2);b([E()],m.prototype,"deleteInputValue",2);b([E()],m.prototype,"subscribing",2);b([E()],m.prototype,"subscribed",2);m=b([x("pg-settings")],m);
