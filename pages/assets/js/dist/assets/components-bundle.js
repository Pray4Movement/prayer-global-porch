 ...
 */const G=globalThis,bt=G.ShadowRoot&&(G.ShadyCSS===void 0||G.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,mt=Symbol(),At=new WeakMap;let Bt=class{constructor(t,s,a){if(this._$cssResult$=!0,a!==mt)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o;const s=this.t;if(bt&&t===void 0){const a=s!==void 0&&s.length===1;a&&(t=At.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&At.set(s,t))}return t}toString(){return this.cssText}};const Kt=e=>new Bt(typeof e=="string"?e:e+"",void 0,mt),_t=(e,...t)=>{const s=e.length===1?e[0]:t.reduce((a,i,r)=>a+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[r+1],e[0]);return new Bt(s,e,mt)},Xt=(e,t)=>{if(bt)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of t){const a=document.createElement("style"),i=G.litNonce;i!==void 0&&a.setAttribute("nonce",i),a.textContent=s.cssText,e.appendChild(a)}},Ot=bt?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(const a of t.cssRules)s+=a.cssText;return Kt(s)})(e):e;/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=globalThis,tt=J.trustedTypes,jt=tt?tt.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ht="$lit$",S=`lit$${Math.random().toFixed(9).slice(2)}$`,Lt="?"+S,ie=`<${Lt}>`,R=document,V=()=>R.createComment(""),K=e=>e===null||typeof e!="object"&&typeof e!="function",ft=Array.isArray,ae=e=>ft(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",ct=`[ 	
\f\r]`,q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,St=/-->/g,Et=/>/g,T=RegExp(`>|${ct}(?:([^\\s"'>=/]+)(${ct}*=${ct}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ct=/'/g,kt=/"/g,zt=/^(?:script|style|textarea|title)$/i,ne=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),l=ne(1),I=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),Tt=new WeakMap,U=R.createTreeWalker(R,129);function qt(e,t){if(!ft(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return jt!==void 0?jt.createHTML(t):t}const re=(e,t)=>{const s=e.length-1,a=[];let i,r=t===2?"<svg>":t===3?"<math>":"",n=q;for(let d=0;d<s;d++){const o=e[d];let h,p,c=-1,b=0;for(;b<o.length&&(n.lastIndex=b,p=n.exec(o),p!==null);)b=n.lastIndex,n===q?p[1]==="!--"?n=St:p[1]!==void 0?n=Et:p[2]!==void 0?(zt.test(p[2])&&(i=RegExp("</"+p[2],"g")),n=T):p[3]!==void 0&&(n=T):n===T?p[0]===">"?(n=i??q,c=-1):p[1]===void 0?c=-2:(c=n.lastIndex-p[2].length,h=p[1],n=p[3]===void 0?T:p[3]==='"'?kt:Ct):n===kt||n===Ct?n=T:n===St||n===Et?n=q:(n=T,i=void 0);const u=n===T&&e[d+1].startsWith("/>")?" ":"";r+=n===q?o+ie:c>=0?(a.push(h),o.slice(0,c)+Ht+o.slice(c)+S+u):o+S+(c===-2?d:u)}return[qt(e,r+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]};class X{constructor({strings:t,_$litType$:s},a){let i;this.parts=[];let r=0,n=0;const d=t.length-1,o=this.parts,[h,p]=re(t,s);if(this.el=X.createElement(h,a),U.currentNode=this.el.content,s===2||s===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(i=U.nextNode())!==null&&o.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(const c of i.getAttributeNames())if(c.endsWith(Ht)){const b=p[n++],u=i.getAttribute(c).split(S),_=/([.?@])?(.*)/.exec(b);o.push({type:1,index:r,name:_[2],strings:u,ctor:_[1]==="."?le:_[1]==="?"?de:_[1]==="@"?ce:rt}),i.removeAttribute(c)}else c.startsWith(S)&&(o.push({type:6,index:r}),i.removeAttribute(c));if(zt.test(i.tagName)){const c=i.textContent.split(S),b=c.length-1;if(b>0){i.textContent=tt?tt.emptyScript:"";for(let u=0;u<b;u++)i.append(c[u],V()),U.nextNode(),o.push({type:2,index:++r});i.append(c[b],V())}}}else if(i.nodeType===8)if(i.data===Lt)o.push({type:2,index:r});else{let c=-1;for(;(c=i.data.indexOf(S,c+1))!==-1;)o.push({type:7,index:r}),c+=S.length-1}r++}}static createElement(t,s){const a=R.createElement("template");return a.innerHTML=t,a}}function B(e,t,s=e,a){var n,d;if(t===I)return t;let i=a!==void 0?(n=s._$Co)==null?void 0:n[a]:s._$Cl;const r=K(t)?void 0:t._$litDirective$;return(i==null?void 0:i.constructor)!==r&&((d=i==null?void 0:i._$AO)==null||d.call(i,!1),r===void 0?i=void 0:(i=new r(e),i._$AT(e,s,a)),a!==void 0?(s._$Co??(s._$Co=[]))[a]=i:s._$Cl=i),i!==void 0&&(t=B(e,i._$AS(e,t.values),i,a)),t}let oe=class{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:s},parts:a}=this._$AD,i=((t==null?void 0:t.creationScope)??R).importNode(s,!0);U.currentNode=i;let r=U.nextNode(),n=0,d=0,o=a[0];for(;o!==void 0;){if(n===o.index){let h;o.type===2?h=new L(r,r.nextSibling,this,t):o.type===1?h=new o.ctor(r,o.name,o.strings,this,t):o.type===6&&(h=new he(r,this,t)),this._$AV.push(h),o=a[++d]}n!==(o==null?void 0:o.index)&&(r=U.nextNode(),n++)}return U.currentNode=R,i}p(t){let s=0;for(const a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,s),s+=a.strings.length-2):a._$AI(t[s])),s++}};class L{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,s,a,i){this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=a,this.options=i,this._$Cv=(i==null?void 0:i.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=B(this,t,s),K(t)?t===v||t==null||t===""?(this._$AH!==v&&this._$AR(),this._$AH=v):t!==this._$AH&&t!==I&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ae(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==v&&K(this._$AH)?this._$AA.nextSibling.data=t:this.T(R.createTextNode(t)),this._$AH=t}$(t){var r;const{values:s,_$litType$:a}=t,i=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=X.createElement(qt(a.h,a.h[0]),this.options)),a);if(((r=this._$AH)==null?void 0:r._$AD)===i)this._$AH.p(s);else{const n=new oe(i,this),d=n.u(this.options);n.p(s),this.T(d),this._$AH=n}}_$AC(t){let s=Tt.get(t.strings);return s===void 0&&Tt.set(t.strings,s=new X(t)),s}k(t){ft(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let a,i=0;for(const r of t)i===s.length?s.push(a=new L(this.O(V()),this.O(V()),this,this.options)):a=s[i],a._$AI(r),i++;i<s.length&&(this._$AR(a&&a._$AB.nextSibling,i),s.length=i)}_$AR(t=this._$AA.nextSibling,s){var a;for((a=this._$AP)==null?void 0:a.call(this,!1,!0,s);t&&t!==this._$AB;){const i=t.nextSibling;t.remove(),t=i}}setConnected(t){var s;this._$AM===void 0&&(this._$Cv=t,(s=this._$AP)==null||s.call(this,t))}}class rt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,a,i,r){this.type=1,this._$AH=v,this._$AN=void 0,this.element=t,this.name=s,this._$AM=i,this.options=r,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=v}_$AI(t,s=this,a,i){const r=this.strings;let n=!1;if(r===void 0)t=B(this,t,s,0),n=!K(t)||t!==this._$AH&&t!==I,n&&(this._$AH=t);else{const d=t;let o,h;for(t=r[0],o=0;o<r.length-1;o++)h=B(this,d[a+o],s,o),h===I&&(h=this._$AH[o]),n||(n=!K(h)||h!==this._$AH[o]),h===v?t=v:t!==v&&(t+=(h??"")+r[o+1]),this._$AH[o]=h}n&&!i&&this.j(t)}j(t){t===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class le extends rt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===v?void 0:t}}class de extends rt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==v)}}class ce extends rt{constructor(t,s,a,i,r){super(t,s,a,i,r),this.type=5}_$AI(t,s=this){if((t=B(this,t,s,0)??v)===I)return;const a=this._$AH,i=t===v&&a!==v||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,r=t!==v&&(a===v||i);i&&this.element.removeEventListener(this.name,this,a),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var s;typeof this._$AH=="function"?this._$AH.call(((s=this.options)==null?void 0:s.host)??this.element,t):this._$AH.handleEvent(t)}}class he{constructor(t,s,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){B(this,t)}}const pe={I:L},ht=J.litHtmlPolyfillSupport;ht==null||ht(X,L),(J.litHtmlVersions??(J.litHtmlVersions=[])).push("3.2.1");const ue=(e,t,s)=>{const a=(s==null?void 0:s.renderBefore)??t;let i=a._$litPart$;if(i===void 0){const r=(s==null?void 0:s.renderBefore)??null;a._$litPart$=i=new L(t.insertBefore(V(),r),r,void 0,s??{})}return i._$AI(e),i};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
    ...
    `}};Ut=He([f("pg-badges")],Ut);var Le=Object.defineProperty,ze=Object.getOwnPropertyDescriptor,Q=(e,t,s,a)=>{for(var i=a>1?void 0:a?ze(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(a?n(t,s,i):n(i))||i);return a&&i&&Le(t,s,i),i};let H=class extends w{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations,this.spritesheetUrl=window.jsObject.spritesheet_url,this.sliderElement=null,this.lastScrollLeft=0,this.scrollTimeout=null,this.badgeId="",this.badge={},this.currentBadgeIndex=0,this.currentBadge={}}connectedCallback(){super.connectedCallback();const e=window.jsObject.available_badges;this.badge=e.find(t=>t.id===this.badgeId),this.currentBadge=this.badge}firstUpdated(){if(this.badge.type!=="progression")return;const e=this.renderRoot.querySelector(".badge-slides");if(e){this.sliderElement=e;let t=null;for(const s of this.badge.progression_badges)if(!s.has_earned_badge){t=s;break}this.slideToEarnedBadge(t)}}getImageUrl(e){return e.has_earned_badge?e.image:e.bw_image}onSliderScroll(e){if(this.badge.type!=="progression"||!this.sliderElement)return;const t=5,s=.01;this.scrollTimeout=setTimeout(()=>{if(!this.sliderElement)return;const a=Math.abs((this.sliderElement.scrollLeft-this.lastScrollLeft)*(t/1e3));this.lastScrollLeft=this.sliderElement.scrollLeft,a<s&&this.setCurrentBadge()},t)}onSliderScrollEnd(e){this.scrollTimeout&&clearTimeout(this.scrollTimeout),this.setCurrentBadge()}slideToEarnedBadge(e){this.badge.type==="progression"&&this.sliderElement&&e&&this.sliderElement.scrollTo({left:this.sliderElement.scrollWidth*(this.badge.progression_badges.indexOf(e)/(this.badge.progression_badges.length+1))})}setCurrentBadge(){this.badge.type==="progression"&&this.sliderElement&&(this.currentBadgeIndex=Math.round(this.sliderElement.scrollLeft/this.sliderElement.scrollWidth*(this.badge.progression_badges.length+1)),this.currentBadge=this.badge.progression_badges[this.currentBadgeIndex])}render(){return l`
      ...
      <div class="brand-bg white page px-3 text-center">
        ...
        <div class="pg-container stack-sm badge-item" data-grid data-small>
            ...
            `}
            ${this.badge.type==="progression"&&this.badge.progression_value&&!this.currentBadge.has_earned_badge?l`
                    <div>
