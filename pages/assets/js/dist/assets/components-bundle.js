 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function m(s){return v({...s,state:!0,attribute:!1})}var le=Object.defineProperty,ce=Object.getOwnPropertyDescriptor,Ut=(s,t,e,a)=>{for(var i=a>1?void 0:a?ce(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&le(t,e,i),i};let X=class extends E{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return h`
      <div class="circle">
    ...
    `];Ut([v({type:String})],X.prototype,"text",2);X=Ut([b("pg-avatar")],X);class S extends E{constructor(){super()}createRenderRoot(){return this}}var de=Object.defineProperty,he=Object.getOwnPropertyDescriptor,Nt=(s,t,e,a)=>{for(var i=a>1?void 0:a?he(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&de(t,e,i),i};let ot=class extends S{constructor(){super(...arguments),this.title=""}render(){return h`
  ...
  `;zt([v({type:String})],Y.prototype,"href",2);Y=zt([b("nav-link")],Y);var be=Object.defineProperty,we=Object.getOwnPropertyDescriptor,w=(s,t,e,a)=>{for(var i=a>1?void 0:a?we(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&be(t,e,i),i};let f=class extends S{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return h`
      <svg>
    ...
    `}};w([v({type:String})],f.prototype,"name",2);w([v({type:Number})],f.prototype,"lapNumber",2);w([v({type:Number})],f.prototype,"progress",2);w([v({type:Object})],f.prototype,"translations",2);w([v({type:String})],f.prototype,"spritesheetUrl",2);w([v({type:String})],f.prototype,"relayType",2);w([v({type:String})],f.prototype,"visibility",2);w([v({type:String})],f.prototype,"urlRoot",2);w([v({type:Boolean})],f.prototype,"hiddenRelay",2);f=w([b("pg-relay-item")],f);var Ae=Object.getOwnPropertyDescriptor,xe=(s,t,e,a)=>{for(var i=a>1?void 0:a?Ae(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let xt=class extends S{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return h`
    ...
    `}};xt=xe([b("pg-activity")],xt);var Oe=Object.getOwnPropertyDescriptor,Pe=(s,t,e,a)=>{for(var i=a>1?void 0:a?Oe(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=n(i)||i);return i};let Ot=class extends S{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return h`
    ...
    `}};Ot=Pe([b("pg-dashboard")],Ot);var je=Object.defineProperty,Ee=Object.getOwnPropertyDescriptor,A=(s,t,e,a)=>{for(var i=a>1?void 0:a?Ee(t,e):t,r=s.length-1,n;r>=0;r--)(n=s[r])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&je(t,e,i),i};let y=class extends S{constructor(){super(),this.translations=window.jsObject.translations,this.saving=!1,this.step="choose-option",this.type="",this.title="",this.showAdvancedOptions=!1,this.startDate="",this.startTime="",this.endDate="",this.endTime=""}createRelay(s){this.step="new-relay",this.type=s}getIcon(){return`${window.jsObject.spritesheet_url}#${this.type==="public"?"pg-world-light":"pg-private"}`}getTitle(){return this.type==="public"?this.translations.create_public_relay:this.translations.create_private_relay}handleChangeTitle(s){this.title=s}handleDateTimeChange(s,t){const e=s.target.value;this[t]=e}onSubmit(s){s.preventDefault();const t={title:this.title,visibility:this.type};this.startDate&&this.startTime&&(t.start_date=new Date(`${this.startDate} ${this.startTime}`).getTime()/1e3),this.endDate&&this.endTime&&(t.end_date=new Date(`${this.endDate} ${this.endTime}`).getTime()/1e3),window.api_fetch(window.pg_global.root+"pg-api/v1/dashboard/create_relay",{method:"POST",body:JSON.stringify(t)}).then(e=>{window.location.href="/dashboard/relays"})}onCancel(){this.step="choose-option"}openAdvancedOptions(){this.showAdvancedOptions=!0}setTimestampToNow(){this.startDate=window.toDateInputFormat(Date.now()/1e3),this.startTime=window.toTimeInputFormat(Date.now()/1e3)}render(){return h`
    ...
    `}};A([m()],y.prototype,"saving",2);A([m()],y.prototype,"step",2);A([m()],y.prototype,"type",2);A([m()],y.prototype,"title",2);A([m()],y.prototype,"showAdvancedOptions",2);A([m()],y.prototype,"startDate",2);A([m()],y.prototype,"startTime",2);A([m()],y.prototype,"endDate",2);A([m()],y.prototype,"endTime",2);y=A([b("pg-new-relay")],y);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Se={CHILD:2},Ce=s=>(...t)=>({_$litDirective$:s,values:t});class Te{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,a){this._$Ct=t,this._$AM=e,this._$Ci=a}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
