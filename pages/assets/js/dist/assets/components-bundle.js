 ...
 */function g(s){return f({...s,state:!0,attribute:!1})}var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,Lt=(s,t,e,a)=>{for(var i=a>1?void 0:a?pe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&de(t,e,i),i};let G=class extends k{constructor(){super(...arguments),this.text=""}updated(s){s.has("text")&&document.querySelectorAll("pg-avatar").forEach(e=>{e.text!==this.text&&(e.text=this.text)})}getInitials(s){const t=s.split(" ").map(e=>e[0]).join("").toUpperCase().slice(0,2);return t.length===0?"?":t}render(){return h`
    ...
    `}};yt([f({type:String})],Y.prototype,"title",2);yt([f({type:String})],Y.prototype,"backUrl",2);Y=yt([v("pg-header")],Y);var be=Object.defineProperty,ve=Object.getOwnPropertyDescriptor,zt=(s,t,e,a)=>{for(var i=a>1?void 0:a?ve(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&be(t,e,i),i};let tt=class extends k{constructor(){super(...arguments),this.open=!1,this.modalId=this.generateId()}generateId(){return Array(6).fill("").map(()=>String.fromCharCode(97+Math.floor(Math.random()*26))).join("")}render(){return h`
      <div
  ...
  `;Bt([f({type:String})],et.prototype,"href",2);et=Bt([v("nav-link")],et);var Oe=Object.defineProperty,xe=Object.getOwnPropertyDescriptor,A=(s,t,e,a)=>{for(var i=a>1?void 0:a?xe(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=(a?n(t,e,i):n(i))||i);return a&&i&&Oe(t,e,i),i};let $=class extends j{constructor(){super(...arguments),this.name="",this.lapNumber=0,this.progress=0,this.translations={},this.spritesheetUrl="",this.relayType="global",this.visibility="public",this.urlRoot="",this.hiddenRelay=!1,this.isOwner=!1,this.token=""}connectedCallback(){super.connectedCallback(),this.token=this.name.replace(/\s+/g,"-")}renderIcon(){const t={global:"pg-logo-prayer",custom:this.visibility==="private"?"pg-private":"pg-world-light"}[this.relayType]||"pg-logo-prayer";return h`
    ...
    `}};O([f({type:Boolean})],b.prototype,"edit",2);O([f({type:Object})],b.prototype,"relay",2);O([g()],b.prototype,"type",2);O([g()],b.prototype,"title",2);O([g()],b.prototype,"showAdvancedOptions",2);O([g()],b.prototype,"startDate",2);O([g()],b.prototype,"startTime",2);O([g()],b.prototype,"endDate",2);O([g()],b.prototype,"endTime",2);O([g()],b.prototype,"isSingle",2);b=O([v("pg-relay-form")],b);var Se=Object.getOwnPropertyDescriptor,Ee=(s,t,e,a)=>{for(var i=a>1?void 0:a?Se(t,e):t,o=s.length-1,n;o>=0;o--)(n=s[o])&&(i=n(i)||i);return i};let kt=class extends j{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return h`
      <pg-header
        backUrl="/dashboard"
                          ...
                          >
                            ...
                            <div class="space-out">
                              <button
                                ...
                                data-url=${`${window.location.origin}/${s.lap_key}/pray`}
                              >
