 ...
 */function A(n){return $t({...n,state:!0,attribute:!1})}class H extends x{constructor(){super()}createRenderRoot(){return this}}var Bt=Object.getOwnPropertyDescriptor,Vt=(n,t,e,s)=>{for(var i=s>1?void 0:s?Bt(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(i=o(i)||i);return i};let at=class extends H{constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}render(){return p` <h2>Prayer Activity</h2> `}};at=Vt([O("pg-activity")],at);function qt(n){return n?JSON.parse('{"'+n.substring(1).replace(/&/g,'","').replace(/=/g,'":"')+'"}'):{}}function Wt(n,t){let e={};const s=n.split("/").filter(r=>r!=""),i=t.split("/").filter(r=>r!="");return s.map((r,o)=>{/^:/.test(r)&&(e[r.substring(1)]=i[o])}),e}function Jt(n){return n?new RegExp("^(|/)"+n.replace(/:[^\s/]+/g,"([\\wÀ-ÖØ-öø-ÿ-]+)")+"(|/)$"):new RegExp("(^$|^/$)")}function Ft(n,t){if(Jt(t).test(n))return!0}function Kt(n){return class extends n{static get properties(){return{route:{type:String,reflect:!0,attribute:"route"},canceled:{type:Boolean}}}constructor(...t){super(...t),this.route="",this.canceled=!1}connectedCallback(...t){super.connectedCallback(...t),this.routing(this.constructor.routes,(...e)=>this.router(...e)),window.addEventListener("route",()=>{this.routing(this.constructor.routes,(...e)=>this.router(...e))}),window.onpopstate=()=>{window.dispatchEvent(new CustomEvent("route"))}}routed(t,e,s,i,r,o){o&&o(t,e,s,i),r(t,e,s,i)}routing(t,e){this.canceled=!0;const s=decodeURI(window.location.pathname),i=decodeURI(window.location.search);let r=t.filter(a=>a.pattern==="*")[0],o=t.filter(a=>a.pattern!=="*"&&Ft(s,a.pattern))[0],l=qt(i);o?(o.params=Wt(o.pattern,s),o.data=o.data||{},o.authentication&&o.authentication.authenticate&&typeof o.authentication.authenticate=="function"?(this.canceled=!1,Promise.resolve(o.authentication.authenticate.bind(this).call()).then(a=>{this.canceled||(a?o.authorization&&o.authorization.authorize&&typeof o.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(o.authorization.authorize.bind(this).call()).then(h=>{this.canceled||(h?this.routed(o.name,o.params,l,o.data,e,o.callback):this.routed(o.authorization.unauthorized.name,o.params,l,o.data,e,o.callback))})):this.routed(o.name,o.params,l,o.data,e,o.callback):this.routed(o.authentication.unauthenticated.name,o.params,l,o.data,e,o.callback))})):o.authorization&&o.authorization.authorize&&typeof o.authorization.authorize=="function"?(this.canceled=!1,Promise.resolve(o.authorization.authorize.bind(this).call()).then(a=>{this.canceled||(a?this.routed(o.name,o.params,l,o.data,e,o.callback):this.routed(o.authorization.unauthorized.name,o.params,l,o.data,e,o.callback))})):this.routed(o.name,o.params,l,o.data,e,o.callback)):r&&(r.data=r.data||{},this.routed(r.name,{},l,r.data,e,r.callback))}}}function _t(n){return class extends n{navigate(t){window.history.pushState({},null,t),window.dispatchEvent(new CustomEvent("route"))}}}var Zt=Object.getOwnPropertyDescriptor,Qt=(n,t,e,s)=>{for(var i=s>1?void 0:s?Zt(t,e):t,r=n.length-1,o;r>=0;r--)(o=n[r])&&(i=o(i)||i);return i};let lt=class extends _t(H){constructor(){super(...arguments),this.user=window.pg_global.user,this.translations=window.jsObject.translations}navigateToHref(n){n.preventDefault();const{href:t}=n.currentTarget;this.navigate(t)}render(){return p`
    ...
    `}};b([A()],f.prototype,"showEditAccount",2);b([A()],f.prototype,"saving",2);b([A()],f.prototype,"name",2);b([A()],f.prototype,"showDeleteAccount",2);b([A()],f.prototype,"deleteInputValue",2);b([A()],f.prototype,"subscribing",2);b([A()],f.prototype,"subscribed",2);f=b([O("pg-settings")],f);
