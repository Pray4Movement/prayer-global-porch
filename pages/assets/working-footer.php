<footer class="brand-bg white center one-rem py-5 pg-footer" role="contentinfo">
    <div class="container">
        <p>
        ...
        <ul style="list-style: none;">
            ...
            <li><a class="white fw-bold" href="/give"><?php echo esc_html( __( 'Give', 'prayer-global-porch' ) ) ?></a></li>
        </ul>
        <ul style="list-style: none;">
