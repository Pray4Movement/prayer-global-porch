...
class PG_Badge_Manager {
    ...
    private function hydrate_db_badges( array $badges ): array {
        // TODO: this needs to be updated to account for monthly challenges being created programmatically.
    ...
    public function get_new_badges(): array {
        ...
        foreach ( $categories as $category ) {
            ...
            foreach ( $badges as $badge ) {
                if ( $badge->get_type() === PG_Badges::TYPE_PROGRESSION ) {
                    $first_badge_in_progression = $this->first_badge_in_progression( $badge );
