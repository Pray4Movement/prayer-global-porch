...
class Prayer_Global_Show_All extends DT_Magic_Url_Base
{
    ...
    public function body(){
        ...
        $empty_array = [];
        $lists['_for_unity_and_working_together'] = PG_Stacker_Text::_for_unity_and_working_together( $empty_array, $stack, true );

        $empty_array = [];
        $lists['_i_am_statements'] = PG_Stacker_Text::_i_am_statements( $empty_array, $stack, true );
